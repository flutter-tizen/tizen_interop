...
Run `copy_rootstraps.sh` and `build_bindings.sh` in this directory. Dart bindings (`lib/src/.../generated_bindings.dart`) will be regenerated by [ffigen](https://pub.dev/packages/ffigen).

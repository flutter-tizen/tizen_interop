...
std::map<std::string, int> __reserved_base_id_map = {
  ...
  {std::string("ml_data_destroy_cb"), BASE_CALLBACK_ID_ml_data_destroy_cb},
  ...
  {std::string("ttse_activated_mode_changed_cb"), BASE_CALLBACK_ID_ttse_activated_mode_changed_cb},

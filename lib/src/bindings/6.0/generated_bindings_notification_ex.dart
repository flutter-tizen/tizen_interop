/// {@category 6.0/tizen}
library tizen_interop_6_0.notification_ex;
...
/// {@category 6.0/tizen}
class Tizen60NotificationEx {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen60NotificationEx(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen60NotificationEx.fromLookup(
  ...
  /// - `msgid` (in): The identifier of the message to be translated. One of the identifers declared in PO files. The message of `msgid` and `format` must contain the same specifiers and in the same order.
  ...
  ///
  /// **Remarks:**
  /// - After the multi-language handle setted successfully, noti_ex_item_button_get_title()
  ...
  ///
  /// **Remarks:**
  /// - After the multi-language handle setted successfully,

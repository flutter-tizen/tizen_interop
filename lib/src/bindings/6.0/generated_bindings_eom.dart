...
class Tizen60Eom {
  ...
  Tizen60Eom(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen60Eom.fromLookup(
  ...
  late final _eom_set_output_windowPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(eom_output_id,
              ffi.Pointer<Evas_Object>)>>('eom_set_output_window');
  late final _eom_set_output_window = _eom_set_output_windowPtr
      .asFunction<int Function(int, ffi.Pointer<Evas_Object>)>();
}

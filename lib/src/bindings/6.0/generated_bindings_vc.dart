...
class Tizen60Vc {
  ...
  Tizen60Vc(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen60Vc.fromLookup(
  ...
  /// - The `vc_sys_cmd_list` must be released using free() when it is no longer required.
  ///
  /// **Parameters:**

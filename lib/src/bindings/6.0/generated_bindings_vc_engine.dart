/// {@category 6.0/tizen}
library tizen_interop_6_0.vc_engine;
...
class Tizen60VcEngine {
  ...
  ///
  /// **Preconditions:**
  /// - The vce_get_engine_info() should be successful.
  ///
  /// **See also:**
  /// - `vce_get_engine_info()`
  /// - `vce_unload_engine()`
  ...
  ///
  /// **Parameters:**
  /// - `vce_command` (in): The handle to be passed to the vce_set_commands() function
...
///
/// **Preconditions:**
/// - vce_foreach_supported_languages() will invoke this callback.
///
/// **See also:**
/// - `vce_foreach_supported_languages()`
/// @nodoc
...
///
/// **Postconditions:**
/// - vce_start() is called after this function is successful.
///
/// **See also:**
/// - `vce_start()`
/// - `vcd_foreach_command()`
...
///
/// **Preconditions:**
/// - vce_set_recording_data() is successful.
///
/// **See also:**
/// - `vce_start()`
/// - `vce_set_recording_data()`
/// - `vce_result_cb()`
/// - `vce_cancel()`
/// @nodoc
...
/// - `vce_unset_tts_audio_format_request_cb()`
/// @nodoc

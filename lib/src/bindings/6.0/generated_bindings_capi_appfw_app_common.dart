/// {@category 6.0/tizen}
library tizen_interop_6_0.capi_appfw_app_common;
...
/// {@category 6.0/tizen}
class Tizen60CapiAppfwAppCommon {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen60CapiAppfwAppCommon(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen60CapiAppfwAppCommon.fromLookup(
  ...
  ///
  /// **Returns:**
  /// - `0` on success, otherrwise a negative error value
  ///
  /// **Return values:**
  /// - `APP_ERROR_NONE`: Successful

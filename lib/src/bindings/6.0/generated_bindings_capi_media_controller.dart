/// {@category 6.0/tizen}
library tizen_interop_6_0.capi_media_controller;
...
/// {@category 6.0/tizen}
class Tizen60CapiMediaController {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen60CapiMediaController(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen60CapiMediaController.fromLookup(
...
/// Called when the server receives the subtite and 360 mode command from the client.
///
/// **Since Tizen:**
/// - 5.5
///

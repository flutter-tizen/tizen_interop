...
class Tizen60Ma {
  ...
  Tizen60Ma(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen60Ma.fromLookup(
  ...
  /// Adds a wake word used for activating assistant.
  ///
  /// Different <word, language> pairs identify a different word. For example, <"Hi Tizen", "en_US"> and <"Hi Tizen", "en_GB"> are different words. If <"Hi Tizen", "en_US"> is added, then "Hi Tizen" will not wake the Tizen voice assistant if the wakeup language is set to "en_GB". <"Hi Tizen", "en_GB"> will have to be added for that. Adding the same word twice does not cause any error to be returned.
  ///
  /// **Since Tizen:**
  /// - 6.0
  ///
  ...
  /// Removes a wake word used for activating assistant.
  ///
  /// Different <word, language> pairs identify a different word. For example, <"Hi Tizen", "en_US"> and <"Hi Tizen", "en_GB"> are different words. Removing a word not present on the list does not cause any error to be returned.
  ///
  /// **Since Tizen:**
  /// - 6.0
  ///

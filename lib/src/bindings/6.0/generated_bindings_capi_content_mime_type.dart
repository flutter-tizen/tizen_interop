/// {@category 6.0/tizen}
library tizen_interop_6_0.capi_content_mime_type;
...
/// {@category 6.0/tizen}
class Tizen60CapiContentMimeType {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen60CapiContentMimeType(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen60CapiContentMimeType.fromLookup(

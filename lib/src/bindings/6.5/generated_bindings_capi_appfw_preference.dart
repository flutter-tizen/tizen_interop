/// {@category 6.5/tizen}
library tizen_interop_6_5.capi_appfw_preference;
...
/// {@category 6.5/tizen}
class Tizen65CapiAppfwPreference {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen65CapiAppfwPreference(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen65CapiAppfwPreference.fromLookup(

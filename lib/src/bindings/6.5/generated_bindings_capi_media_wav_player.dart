/// {@category 6.5/tizen}
library tizen_interop_6_5.capi_media_wav_player;
...
/// {@category 6.5/tizen}
class Tizen65CapiMediaWavPlayer {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen65CapiMediaWavPlayer(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen65CapiMediaWavPlayer.fromLookup(

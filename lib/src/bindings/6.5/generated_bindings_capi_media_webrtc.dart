/// {@category 6.5/tizen}
library tizen_interop_6_5.capi_media_webrtc;
...
/// {@category 6.5/tizen}
class Tizen65CapiMediaWebrtc {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen65CapiMediaWebrtc(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen65CapiMediaWebrtc.fromLookup(
  ...
  ///
  /// If `mute` is set to `true`, black frame or silent sound will be transmitted to the remote peer according to the media type of the `source_id`. if `source_id` is a media source of `WEBRTC_MEDIA_SOURCE_TYPE_FILE` or `WEBRTC_MEDIA_SOURCE_TYPE_MEDIA_PACKET`, this function will return `WEBRTC_ERROR_INVALID_PARAMETER`.
  ///
  /// **Since Tizen:**
  /// - 6.5
  ///
  ...
  /// **Parameters:**
  /// - `webrtc` (in): WebRTC handle
  /// - `stun_server` (in): The STUN server URL
  ///
  /// **Returns:**
  /// - `0` on success, otherwise a negative error value
  ///
...
/// Called iteratively to inform all the TURN server URLs.
///
/// **Since Tizen:**
/// - 6.5
///

/// {@category 6.5/tizen}
library tizen_interop_6_5.capi_nntrainer;
...
/// {@category 6.5/tizen}
class Tizen65CapiNntrainer {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen65CapiNntrainer(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen65CapiNntrainer.fromLookup(
  ...
  int ml_train_model_get_input_tensors_info(
    ml_train_model_h model,
    ffi.Pointer<nnstreamer.ml_tensors_info_h> info,
  ) {
  ...
  late final _ml_train_model_get_input_tensors_infoPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(ml_train_model_h,
                  ffi.Pointer<nnstreamer.ml_tensors_info_h>)>>(
  ...
  late final _ml_train_model_get_input_tensors_info =
      _ml_train_model_get_input_tensors_infoPtr.asFunction<
          int Function(
              ml_train_model_h, ffi.Pointer<nnstreamer.ml_tensors_info_h>)>();
  ...
  /// - added to the `dataset`, it is recommened to use

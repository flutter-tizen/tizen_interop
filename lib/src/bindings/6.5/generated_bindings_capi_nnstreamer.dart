/// {@category 6.5/tizen}
library tizen_interop_6_5.capi_nnstreamer;
...
/// {@category 6.5/tizen}
class Tizen65CapiNnstreamer {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen65CapiNnstreamer(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen65CapiNnstreamer.fromLookup(
  ...
  late final _ml_pipeline_src_input_dataPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(ml_pipeline_src_h, ml_tensors_data_h,
              ffi.Int32)>>('ml_pipeline_src_input_data');
  late final _ml_pipeline_src_input_data = _ml_pipeline_src_input_dataPtr
      .asFunction<int Function(ml_pipeline_src_h, ml_tensors_data_h, int)>();
  ...
  late final _ml_pipeline_src_get_tensors_infoPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  ml_pipeline_src_h, ffi.Pointer<ml_tensors_info_h>)>>(
  ...
  late final _ml_pipeline_src_get_tensors_info =
      _ml_pipeline_src_get_tensors_infoPtr.asFunction<
          int Function(ml_pipeline_src_h, ffi.Pointer<ml_tensors_info_h>)>();
  ...
  /// - `elem_h` (in): The target element handle.
  /// - `property_name` (in): The name of the property.
  /// - `value` (out): The string value of given property.
  ///
  /// **Returns:**
  /// - `0` on success. Otherwise a negative error value.
  ///
...
abstract class ml_nnfw_type_e {
  ...
  /// < Qualcomm SNPE (Snapdgragon Neural Processing Engine (.dlc). (Since 6.0)
...
abstract class ml_tensor_type_e {
  ...
  /// < Unknown type
  static const int ML_TENSOR_TYPE_UNKNOWN = 10;
}
...
///
/// **Parameters:**
/// - `data` (in): The handle of the tensor output of the pipeline (a single frame. tensor/tensors). Number of tensors is determined by ml_tensors_info_get_count() with the handle 'info'. Note that the maximum number of tensors is 16 (`ML_TENSOR_SIZE_LIMIT`).
...
/// @nodoc
typedef ml_pipeline_sink_cbFunction = ffi.Void Function(ml_tensors_data_h data,
    ml_tensors_info_h info, ffi.Pointer<ffi.Void> user_data);
/// @nodoc
typedef Dartml_pipeline_sink_cbFunction = void Function(ml_tensors_data_h data,
    ml_tensors_info_h info, ffi.Pointer<ffi.Void> user_data);

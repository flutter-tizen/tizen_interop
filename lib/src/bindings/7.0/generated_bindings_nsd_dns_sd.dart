/// {@category 7.0/tizen}
library tizen_interop_7_0.nsd_dns_sd;
...
/// {@category 7.0/tizen}
class Tizen70NsdDnsSd {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen70NsdDnsSd(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen70NsdDnsSd.fromLookup(
  ...
  /// Sets the interface name of DNSSD local service. @detail The `interface` is the interface of network card that this service is provided (e.g. wlan0, eth0, etc.).
  ///
  /// **Since Tizen:**
  /// - 7.0
  ///
  ...
  int dnssd_service_set_interface(
    ...
    return _dnssd_service_set_interface(
      local_service,
      interface1,
    );
  }

  late final _dnssd_service_set_interfacePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(dnssd_service_h,
              ffi.Pointer<ffi.Char>)>>('dnssd_service_set_interface');
  ...
  int dnssd_service_get_interface(
    ...
    return _dnssd_service_get_interface(
      service,
      interface1,
    );
  }

  late final _dnssd_service_get_interfacePtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(
                  dnssd_service_h, ffi.Pointer<ffi.Pointer<ffi.Char>>)>>(
  ...
  int dnssd_browse_service(
    ffi.Pointer<ffi.Char> service_type,
    ffi.Pointer<ffi.Char> interface1,
    ffi.Pointer<dnssd_browser_h> browser,
    dnssd_found_cb found_cb,
    ffi.Pointer<ffi.Void> user_data,
  ) {
    return _dnssd_browse_service(
      service_type,
      interface1,
      browser,
      found_cb,
  ...
  late final _dnssd_browse_servicePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<dnssd_browser_h>,
              dnssd_found_cb,
              ffi.Pointer<ffi.Void>)>>('dnssd_browse_service');
  late final _dnssd_browse_service = _dnssd_browse_servicePtr.asFunction<
      int Function(
          ffi.Pointer<ffi.Char>,
          ffi.Pointer<ffi.Char>,
          ffi.Pointer<dnssd_browser_h>,
  ...
  int dnssd_cancel_browse_service(
    ...
    return _dnssd_cancel_browse_service(
      browser,
    );
  }

  late final _dnssd_cancel_browse_servicePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(dnssd_browser_h)>>(
          'dnssd_cancel_browse_service');
  ...
  late final _dnssd_resolve_servicePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(dnssd_service_h, dnssd_resolved_cb,
              ffi.Pointer<ffi.Void>)>>('dnssd_resolve_service');
  ...
  int dnssd_cancel_resolve_service(
    ...
    return _dnssd_cancel_resolve_service(
      remote_service,
    );
  }

  late final _dnssd_cancel_resolve_servicePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(dnssd_service_h)>>(
          'dnssd_cancel_resolve_service');
  ...
  int dnssd_create_remote_service(
    ...
    ffi.Pointer<ffi.Char> service_name,
    ffi.Pointer<ffi.Char> interface1,
    ffi.Pointer<dnssd_service_h> remote_service,
  ) {
    return _dnssd_create_remote_service(
      service_type,
      service_name,
      interface1,
      remote_service,
  ...
  late final _dnssd_create_remote_servicePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<ffi.Char>,
              ffi.Pointer<dnssd_service_h>)>>('dnssd_create_remote_service');
  late final _dnssd_create_remote_service =
      _dnssd_create_remote_servicePtr.asFunction<
  ...
  int dnssd_destroy_remote_service(
    ...
    return _dnssd_destroy_remote_service(
      remote_service,
    );
  }

  late final _dnssd_destroy_remote_servicePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(dnssd_service_h)>>(
          'dnssd_destroy_remote_service');

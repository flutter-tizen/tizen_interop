/// {@category 7.0/tizen}
library tizen_interop_7_0.accounts_svc;
...
/// {@category 7.0/tizen}
class Tizen70AccountsSvc {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen70AccountsSvc(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen70AccountsSvc.fromLookup(
  ...
  ///
  /// **Preconditions:**
  /// - This function requires an open connection to an account service by account_connect() on tizen 2.3 (MOBILE). But the account_connect() is not required to use this function since tizen 2.4.
  ///
  /// **See also:**
  ...
  ///
  /// **Return values:**
  /// - `TRUE`: means the application supports the given capability
  /// - `FALSE`: means the application does not support the given capability
  ///
  /// **Exceptions:**
  /// - `ACCOUNT_ERROR_NONE`: Successful
  /// - `ACCOUNT_ERROR_INVALID_PARAMETER`: Invalid parameter

/// {@category 7.0/tizen}
library tizen_interop_7_0.diagnostics;
...
/// {@category 7.0/tizen}
class Tizen70Diagnostics {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen70Diagnostics(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen70Diagnostics.fromLookup(
  ...
  ///
  /// **Remarks:**
  /// - This function provides a file descriptor to read/write diagnostic data in a custom way

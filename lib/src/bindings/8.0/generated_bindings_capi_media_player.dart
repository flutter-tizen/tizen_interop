/// {@category 8.0/tizen}
library tizen_interop_8_0.capi_media_player;
...
/// {@category 8.0/tizen}
class Tizen80CapiMediaPlayer {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen80CapiMediaPlayer(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen80CapiMediaPlayer.fromLookup(
  ...
  /// Sets the default codec type of the video decoder.
  ///
  /// **Since Tizen:**
  /// - 8.0
  ///
  ...
  int player_set_video_codec_type(
    player_h player,
    int codec_type,
  ) {
  ...
  late final _player_set_video_codec_typePtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(player_h, ffi.Int32)>>(
          'player_set_video_codec_type');
  late final _player_set_video_codec_type =
      _player_set_video_codec_typePtr.asFunction<int Function(player_h, int)>();

  /// Gets the default codec type of the video decoder.
  ///
  /// **Since Tizen:**
  /// - 8.0
  ///
  ...
  /// **See also:**
  /// - `player_set_video_codec_type()`
  int player_get_video_codec_type(
    player_h player,
    ffi.Pointer<ffi.Int32> codec_type,
  ) {
    return _player_get_video_codec_type(
      player,
      codec_type,
    );
  }

  late final _player_get_video_codec_typePtr = _lookup<
          ffi
          .NativeFunction<ffi.Int Function(player_h, ffi.Pointer<ffi.Int32>)>>(
      'player_get_video_codec_type');
  late final _player_get_video_codec_type = _player_get_video_codec_typePtr
      .asFunction<int Function(player_h, ffi.Pointer<ffi.Int32>)>();
  ...
  ///
  /// This function is to set horizontal (yaw) and vertical (pitch) angles of current direction of view in radians. Default direction of view is taken from meta-data stored in the media. If meta-data omits these values, zeros are assumed to be equal to the center of the panorama image.
  ///
  /// **Since Tizen:**
  /// - 5.0
  ///

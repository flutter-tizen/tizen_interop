...
class Tizen80Vc {
  ...
  ///
  /// **Remarks:**
  /// - If the function succeeds, `vc_command` must be released with vc_cmd_destroy() or vc_cmd_list_destroy().
  ...
  ///
  /// **Remarks:**
  /// - If `name` is `NULL`, the invocation name will be unset.
  ///
  /// **Parameters:**
  ...
  ///
  /// **Remarks:**
  /// - If `app_id` is `NULL`, the API tries to get app ID using app manager framework.
  ...
  /// - `disp_text` and `utt_text` allow `NULL`. However, it is not allowed to set both `disp_text` and `utt_text` as `NULL`.
  ///
  /// **Parameters:**

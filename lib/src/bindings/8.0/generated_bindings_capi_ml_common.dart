/// {@category 8.0/tizen}
library tizen_interop_8_0.capi_ml_common;
...
/// {@category 8.0/tizen}
class Tizen80CapiMlCommon {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen80CapiMlCommon(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen80CapiMlCommon.fromLookup(
  ...
  int _force_generate_app_event_handle_h(
    ml_custom_easy_invoke_cb callback,
  ) {
  ...
  late final __force_generate_app_event_handle_hPtr =
      _lookup<ffi.NativeFunction<ffi.Int Function(ml_custom_easy_invoke_cb)>>(

/// {@category 8.0/tizen}
library tizen_interop_8_0.capi_content_mime_type;
...
/// {@category 8.0/tizen}
class Tizen80CapiContentMimeType {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen80CapiContentMimeType(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen80CapiContentMimeType.fromLookup(

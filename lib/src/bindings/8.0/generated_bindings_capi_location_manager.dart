/// {@category 8.0/tizen}
library tizen_interop_8_0.capi_location_manager;
...
/// {@category 8.0/tizen}
class Tizen80CapiLocationManager {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen80CapiLocationManager(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen80CapiLocationManager.fromLookup(

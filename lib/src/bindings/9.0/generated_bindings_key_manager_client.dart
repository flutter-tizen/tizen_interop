/// {@category 9.0/tizen}
library tizen_interop_9_0.key_manager_client;
...
/// {@category 9.0/tizen}
class Tizen90KeyManagerClient {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen90KeyManagerClient(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen90KeyManagerClient.fromLookup(
  ...
  /// - Existing parameter will be overwritten by value passed in `name`.
  /// - Passing invalid parameter name will result in an error.
  /// - Caller is responsible for creatingand freeing the `buffer`.
  ///
  /// **Parameters:**
  /// - `params` (in): Algorithm param list handle created with ckmc_param_list_new() or ckmc_generate_new_params()
  /// - `name` (in): Name of parameter to set

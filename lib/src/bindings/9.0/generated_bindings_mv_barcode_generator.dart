/// {@category 9.0/tizen}
library tizen_interop_9_0.mv_barcode_generator;
...
/// {@category 9.0/tizen}
class Tizen90MvBarcodeGenerator {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen90MvBarcodeGenerator(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen90MvBarcodeGenerator.fromLookup(
...
abstract class mv_barcode_generate_attr_shape_e {
  ...
  /// < Round rectangular
  static const int MV_BARCODE_GENERATE_ATTR_SHAPE_ROUND_RECT = 1;

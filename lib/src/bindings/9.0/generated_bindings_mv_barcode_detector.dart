/// {@category 9.0/tizen}
library tizen_interop_9_0.mv_barcode_detector;
...
/// {@category 9.0/tizen}
class Tizen90MvBarcodeDetector {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen90MvBarcodeDetector(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen90MvBarcodeDetector.fromLookup(
...
abstract class mv_barcode_detect_attr_rotation_direction_e {
  ...
  /// < Counter clockwise
  static const int MV_BARCODE_DETECT_ATTR_ROTATION_COUNTER_CLOCKWISE = 1;

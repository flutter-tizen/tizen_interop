/// {@category 9.0/tizen}
library tizen_interop_9_0.capi_web_url_download;
...
class Tizen90CapiWebUrlDownload {
  ...
  /// **Parameters:**
  /// - `download_id` (in): The download ID
  /// - `file_name` (in): The file name for the downloaded file If `file_name` is `NULL` it clears the previous value.
  ///
  /// **Returns:**
  /// - `0` on success, otherwise a negative error value
  ///
  ...
  ///
  /// **Remarks:**
  /// - You must release `fields` using free().
  ///
  /// **Parameters:**
  /// - `download_id` (in): The download ID
  ...
  ///
  /// **Remarks:**
  /// - The `temp_path` should be released using free().
  ///
  /// **Parameters:**
  /// - `download_id` (in): The download ID
  ...
  ///
  /// **Remarks:**
  /// - The `content_name` should be released using free().
  ///
  /// **Parameters:**
  /// - `download_id` (in): The download ID
  ...
  /// - The `etag` should be released using free().
  ///
  /// **Parameters:**
  /// - `download_id` (in): The download ID

...
final Map<String, List<String>> tizen40Symbols = {
  ...
  'libappcore-watch.so.1': [
    'watch_app_add_event_handler',
    'watch_app_exit',
    'watch_app_get_ambient_tick_type',
    'watch_app_get_elm_win',
    ...
    'watch_time_get_day',
    'watch_time_get_daylight_time_status',
    'watch_time_get_day_of_week',
    'watch_time_get_dst_status',
    'watch_time_get_hour',
  ...
  'libcapi-appfw-widget-application.so.1': [
  ...
  'libwidget_service.so.1': [
    'widget_instance_change_period',
    'widget_instance_create',
    'widget_instance_destroy',
    'widget_instance_fini',
    'widget_instance_foreach',
    'widget_instance_get_content',
    'widget_instance_get_error_code',
    'widget_instance_get_height',
    'widget_instance_get_id',
    'widget_instance_get_instance',
    'widget_instance_get_instance_list',
    'widget_instance_get_period',
    'widget_instance_get_width',
    'widget_instance_init',
    'widget_instance_launch',
    'widget_instance_listen_event',
    'widget_instance_listen_status',
    'widget_instance_pause',
    'widget_instance_ref',
    'widget_instance_resize',
    'widget_instance_resume',
    'widget_instance_terminate',
    'widget_instance_trigger_update',
    'widget_instance_trigger_update_v2',
    'widget_instance_unlisten_event',
    'widget_instance_unlisten_status',
    'widget_instance_unref',
    'widget_service_change_period',
    'widget_service_check_db_integrity',
    'widget_service_get_app_id_of_setup_app',
    'widget_service_get_content_of_widget_instance',
    'widget_service_get_icon',
    'widget_service_get_instance_count',
  ...
  'libwidget_viewer_evas.so.1': [
    ...
    'widget_viewer_evas_launch_setup_app',
    ...
    'widget_viewer_evas_set_delayed_resuming_time',
  ...
  'libcapi-maps-service.so.0': [
    ...
    'maps_item_hashtable_get_float',
    'maps_item_hashtable_get_int',
    'maps_item_hashtable_get_string',
    ...
    'maps_item_list_clone',
    'maps_item_list_create',
    'maps_item_list_destroy',
    'maps_item_list_foreach',
    'maps_item_list_foreach_noclone',
    'maps_item_list_get_length',
    'maps_item_list_remove',
    'maps_item_list_remove_all',
    'maps_place_attribute_clone',
    'maps_place_attribute_create',
    'maps_place_attribute_destroy',
    'maps_place_attribute_get_id',
    'maps_place_attribute_get_label',
    'maps_place_attribute_get_text',
    'maps_place_attribute_set_id',
    'maps_place_attribute_set_label',
    'maps_place_attribute_set_text',
    ...
    'maps_place_category_set_id',
    'maps_place_category_set_name',
    'maps_place_category_set_url',
    'maps_place_clone',
    'maps_place_contact_clone',
    'maps_place_contact_create',
    'maps_place_contact_destroy',
    'maps_place_contact_get_label',
    'maps_place_contact_get_type',
    'maps_place_contact_get_value',
    'maps_place_contact_set_label',
    'maps_place_contact_set_type',
    'maps_place_contact_set_value',
    'maps_place_create',
    'maps_place_destroy',
    'maps_place_editorial_clone',
    'maps_place_editorial_create',
    ...
    'maps_place_editorial_set_description',
    'maps_place_editorial_set_language',
    'maps_place_editorial_set_media',
    ...
    'maps_place_image_set_height',
    'maps_place_image_set_id',
    'maps_place_image_set_media',
    'maps_place_image_set_url',
    'maps_place_image_set_user_link',
    'maps_place_image_set_width',
    'maps_place_link_object_clone',
    'maps_place_link_object_create',
    ...
    'maps_place_link_object_set_id',
    'maps_place_link_object_set_name',
    'maps_place_link_object_set_string',
    'maps_place_link_object_set_type',
    'maps_place_list_create',
    'maps_place_list_destroy',
    'maps_place_list_foreach',
    'maps_place_media_clone',
    'maps_place_media_create',
    'maps_place_media_destroy',
    'maps_place_media_get_attribution',
    'maps_place_media_get_supplier',
    'maps_place_media_get_via',
    'maps_place_media_set_attribution',
    'maps_place_media_set_supplier',
    'maps_place_media_set_via',
    'maps_place_rating_clone',
    'maps_place_rating_create',
    'maps_place_rating_destroy',
    'maps_place_rating_get_average',
    'maps_place_rating_get_count',
    'maps_place_rating_set_average',
    'maps_place_rating_set_count',
    'maps_place_review_clone',
    'maps_place_review_create',
    ...
    'maps_place_review_set_date',
    'maps_place_review_set_description',
    'maps_place_review_set_language',
    'maps_place_review_set_media',
    'maps_place_review_set_rating',
    'maps_place_review_set_title',
    'maps_place_review_set_user_link',
    'maps_place_set_address',
    'maps_place_set_attributes',
    'maps_place_set_categories',
    'maps_place_set_contacts',
    'maps_place_set_distance',
    'maps_place_set_editorials',
    'maps_place_set_id',
    'maps_place_set_images',
    'maps_place_set_location',
    'maps_place_set_name',
    'maps_place_set_properties',
    'maps_place_set_rating',
    'maps_place_set_related_link',
    'maps_place_set_reviews',
    'maps_place_set_supplier_link',
    'maps_place_set_uri',
    'maps_place_url_clone',
    'maps_place_url_create',
    'maps_place_url_destroy',
    'maps_place_url_get_description',
    'maps_place_url_get_path',
    'maps_place_url_set_description',
    'maps_place_url_set_path',
    'maps_plugin_info_clone',
    'maps_plugin_info_create',
    'maps_plugin_info_destroy',
    'maps_plugin_info_get_provider_name',
    'maps_plugin_info_set_provider_name',
    ...
    'maps_preference_set_country_code',
    'maps_preference_set_distance_unit',
    'maps_preference_set_language',
    'maps_preference_set_max_results',
    'maps_preference_set_property',
    'maps_preference_set_route_alternatives_enabled',
    ...
    'maps_route_maneuver_set_direction_id',
    'maps_route_maneuver_set_distance_to_next_instruction',
    'maps_route_maneuver_set_instruction_text',
    'maps_route_maneuver_set_locale',
    'maps_route_maneuver_set_position',
    'maps_route_maneuver_set_road_name',
    'maps_route_maneuver_set_time_to_next_instruction',
    'maps_route_maneuver_set_turn_type',
    'maps_route_segment_clone',
    'maps_route_segment_create',
    ...
    'maps_route_segment_set_bounding_box',
    'maps_route_segment_set_destination',
    'maps_route_segment_set_distance',
    'maps_route_segment_set_duration',
    'maps_route_segment_set_maneuvers',
    'maps_route_segment_set_origin',
    'maps_route_segment_set_path',
    'maps_route_set_bounding_box',
    'maps_route_set_destination',
    'maps_route_set_distance_unit',
    'maps_route_set_origin',
    'maps_route_set_path',
    'maps_route_set_properties',
    'maps_route_set_route_id',
    'maps_route_set_segments',
    'maps_route_set_total_distance',
    'maps_route_set_total_duration',
    'maps_route_set_transport_mode',
    'maps_service_cancel_request',
    'maps_service_create',
    'maps_service_create_without_user_consent',
    ...
    'maps_service_request_user_consent_with_handle',
    ...
    'maps_view_get_maps_plugin_view_handle',
    ...
    'maps_view_object_marker_set_size',
    ...
    'maps_view_set_maps_plugin_view_handle',
  ...
  'libcapi-messaging-messages.so.0': [
  ...
  'libcapi-media-audio-io.so.0': [
    ...
    'cpp_audio_out_unset_interrupted_cb',
  ...
  'libcapi-media-sound-manager.so.0': [
    ...
    'sound_manager_disable_session_backward_compatibility',
    ...
    'sound_manager_get_internal_voip_stream_information',
  ...
  'libcapi-network-nfc.so.0': [
    'lib_fini',
    'lib_init',
    'llcp_socket_data_append',
    'llcp_socket_data_find',
    'llcp_socket_data_remove',
    'net_nfc_add_carrier_config_group_property',
    'net_nfc_add_carrier_config_property',
    'net_nfc_append_carrier_config_group',
    'net_nfc_append_handover_auxiliary_record',
    'net_nfc_append_handover_carrier',
    'net_nfc_append_handover_carrier_record',
    'net_nfc_append_record_by_index',
    'net_nfc_append_record_to_ndef_message',
    'net_nfc_client_barcode_get_barcode_sync',
    'net_nfc_client_deinitialize',
    'net_nfc_client_felica_poll',
    'net_nfc_client_felica_read_without_encryption',
    'net_nfc_client_felica_request_response',
    'net_nfc_client_felica_request_service',
    ...
    'net_nfc_client_get_nfc_state',
    'net_nfc_client_handover_deinit',
    'net_nfc_client_handover_free_alternative_carrier_data',
    'net_nfc_client_handover_get_alternative_carrier_data',
    'net_nfc_client_handover_get_alternative_carrier_type',
    'net_nfc_client_handover_init',
    'net_nfc_client_handover_set_handover_event_cb',
    'net_nfc_client_handover_unset_handover_event_cb',
    'net_nfc_client_hce_deinit',
    'net_nfc_client_hce_init',
    'net_nfc_client_hce_ipc_deinit',
    'net_nfc_client_hce_ipc_init',
    'net_nfc_client_hce_ipc_is_initialized',
    'net_nfc_client_hce_process_received_event',
    'net_nfc_client_hce_response_apdu_sync',
    'net_nfc_client_hce_set_event_received_cb',
    'net_nfc_client_hce_unset_event_received_cb',
    'net_nfc_client_initialize',
    'net_nfc_client_is_nfc_supported',
    'net_nfc_client_jewel_read_all',
    'net_nfc_client_jewel_read_byte',
    'net_nfc_client_jewel_read_id',
    'net_nfc_client_jewel_write_with_erase',
    'net_nfc_client_jewel_write_with_no_erase',
    'net_nfc_client_llcp_accept',
    'net_nfc_client_llcp_accept_sync',
    'net_nfc_client_llcp_close',
    'net_nfc_client_llcp_close_sync',
    'net_nfc_client_llcp_config',
    'net_nfc_client_llcp_config_sync',
    'net_nfc_client_llcp_connect',
    'net_nfc_client_llcp_connect_sap',
    'net_nfc_client_llcp_connect_sap_sync',
    'net_nfc_client_llcp_connect_sync',
    'net_nfc_client_llcp_create_config',
    'net_nfc_client_llcp_create_config_default',
    'net_nfc_client_llcp_create_socket',
    'net_nfc_client_llcp_create_socket_option',
    'net_nfc_client_llcp_create_socket_option_default',
    'net_nfc_client_llcp_deinit',
    'net_nfc_client_llcp_disconnect',
    'net_nfc_client_llcp_disconnect_sync',
    'net_nfc_client_llcp_free_config',
    'net_nfc_client_llcp_free_socket_option',
    'net_nfc_client_llcp_get_config',
    'net_nfc_client_llcp_get_config_lto',
    'net_nfc_client_llcp_get_config_miu',
    'net_nfc_client_llcp_get_config_option',
    'net_nfc_client_llcp_get_config_wks',
    'net_nfc_client_llcp_get_local_config',
    'net_nfc_client_llcp_get_local_socket_option',
    'net_nfc_client_llcp_get_socket_option_miu',
    'net_nfc_client_llcp_get_socket_option_rw',
    'net_nfc_client_llcp_get_socket_option_type',
    'net_nfc_client_llcp_init',
    'net_nfc_client_llcp_listen',
    'net_nfc_client_llcp_listen_sync',
    'net_nfc_client_llcp_receive',
    'net_nfc_client_llcp_receive_from',
    'net_nfc_client_llcp_receive_from_sync',
    'net_nfc_client_llcp_receive_sync',
    'net_nfc_client_llcp_reject',
    'net_nfc_client_llcp_reject_sync',
    'net_nfc_client_llcp_send',
    'net_nfc_client_llcp_send_sync',
    'net_nfc_client_llcp_send_to',
    'net_nfc_client_llcp_send_to_sync',
    'net_nfc_client_llcp_set_config_lto',
    'net_nfc_client_llcp_set_config_miu',
    'net_nfc_client_llcp_set_config_option',
    'net_nfc_client_llcp_set_config_wks',
    'net_nfc_client_llcp_set_socket_option_miu',
    'net_nfc_client_llcp_set_socket_option_rw',
    'net_nfc_client_llcp_set_socket_option_type',
    'net_nfc_client_manager_deinit',
    'net_nfc_client_manager_get_server_state',
    'net_nfc_client_manager_get_server_state_sync',
    'net_nfc_client_manager_init',
    'net_nfc_client_manager_is_activated',
    'net_nfc_client_manager_set_activated',
    'net_nfc_client_manager_set_active',
    'net_nfc_client_manager_set_active_sync',
    'net_nfc_client_manager_unset_activated',
    'net_nfc_client_mifare_authenticate_with_keyA',
    'net_nfc_client_mifare_authenticate_with_keyB',
    'net_nfc_client_mifare_create_application_directory_key',
    'net_nfc_client_mifare_create_default_key',
    'net_nfc_client_mifare_create_net_nfc_forum_key',
    'net_nfc_client_mifare_decrement',
    'net_nfc_client_mifare_increment',
    'net_nfc_client_mifare_read',
    'net_nfc_client_mifare_restore',
    'net_nfc_client_mifare_transfer',
    'net_nfc_client_mifare_write_block',
    'net_nfc_client_mifare_write_page',
    'net_nfc_client_ndef_deinit',
    'net_nfc_client_ndef_format',
    'net_nfc_client_ndef_format_sync',
    'net_nfc_client_ndef_init',
    'net_nfc_client_ndef_make_read_only',
    'net_nfc_client_ndef_make_read_only_sync',
    'net_nfc_client_ndef_read',
    'net_nfc_client_ndef_read_sync',
    'net_nfc_client_ndef_write',
    'net_nfc_client_ndef_write_sync',
    'net_nfc_client_p2p_connection_handover',
    'net_nfc_client_p2p_connection_handover_sync',
    'net_nfc_client_p2p_deinit',
    'net_nfc_client_p2p_init',
    'net_nfc_client_p2p_send',
    'net_nfc_client_p2p_send_sync',
    ...
    'net_nfc_client_se_add_route_aid_sync',
    'net_nfc_client_se_close_internal_secure_element',
    'net_nfc_client_se_close_internal_secure_element_sync',
    'net_nfc_client_se_deinit',
    'net_nfc_client_se_foreach_registered_aids_sync',
    'net_nfc_client_se_foreach_registered_handlers_sync',
    'net_nfc_client_se_get_atr',
    'net_nfc_client_se_get_atr_sync',
    'net_nfc_client_se_get_conflict_handlers_sync',
    'net_nfc_client_se_get_handler_storage_info_sync',
    'net_nfc_client_se_get_registered_aids_count_sync',
    'net_nfc_client_se_get_secure_element_type_sync',
    'net_nfc_client_se_init',
    'net_nfc_client_se_is_activated_aid_handler_sync',
    'net_nfc_client_se_is_activated_category_handler_sync',
    'net_nfc_client_se_open_internal_secure_element',
    'net_nfc_client_se_open_internal_secure_element_sync',
    'net_nfc_client_se_register_aids_sync',
    'net_nfc_client_se_remove_package_aids_sync',
    'net_nfc_client_se_remove_route_aid_sync',
    'net_nfc_client_se_send_apdu',
    'net_nfc_client_se_send_apdu_sync',
    'net_nfc_client_se_set_default_route_sync',
    'net_nfc_client_se_set_ese_detection_cb',
    'net_nfc_client_se_set_event_cb',
    'net_nfc_client_se_set_preferred_handler_sync',
    'net_nfc_client_se_set_secure_element_type',
    'net_nfc_client_se_set_secure_element_type_sync',
    'net_nfc_client_se_set_transaction_event_cb',
    'net_nfc_client_se_set_transaction_fg_dispatch',
    ...
    'net_nfc_client_snep_init',
    'net_nfc_client_snep_register_server',
    'net_nfc_client_snep_send_client_request',
    'net_nfc_client_snep_start_client',
    ...
    'net_nfc_client_sys_handler_get_launch_popup_state',
    'net_nfc_client_sys_handler_init',
    'net_nfc_client_sys_handler_set_launch_popup_state',
    'net_nfc_client_sys_handler_set_launch_popup_state_force',
    'net_nfc_client_sys_handler_set_state',
    'net_nfc_client_sys_handler_set_state_force',
    'net_nfc_client_sys_handler_set_state_force_sync',
    'net_nfc_client_sys_handler_set_state_sync',
    'net_nfc_client_tag_deinit',
    'net_nfc_client_tag_get_client_target_info',
    'net_nfc_client_tag_get_current_tag_info_sync',
    'net_nfc_client_tag_get_current_target_handle_sync',
    'net_nfc_client_tag_get_filter',
    'net_nfc_client_tag_init',
    'net_nfc_client_tag_is_connected',
    'net_nfc_client_tag_is_tag_connected_sync',
    'net_nfc_client_tag_set_filter',
    ...
    'net_nfc_client_test_ese_test',
    'net_nfc_client_test_ese_test_sync',
    'net_nfc_client_test_get_firmware_version',
    'net_nfc_client_test_get_firmware_version_sync',
    'net_nfc_client_test_init',
    'net_nfc_client_test_prbs_test',
    'net_nfc_client_test_prbs_test_sync',
    'net_nfc_client_test_set_ee_data',
    'net_nfc_client_test_set_ee_data_sync',
    'net_nfc_client_test_set_listen_tech_mask_sync',
    'net_nfc_client_test_set_se_tech_type_sync',
    'net_nfc_client_test_sim_test',
    'net_nfc_client_test_sim_test_sync',
    'net_nfc_client_transceive',
    'net_nfc_client_transceive_data',
    'net_nfc_client_transceive_data_sync',
    'net_nfc_client_transceive_deinit',
    'net_nfc_client_transceive_init',
    'net_nfc_client_transceive_sync',
    'net_nfc_create_carrier_config',
    'net_nfc_create_carrier_config_from_carrier',
    'net_nfc_create_carrier_config_from_config_record',
    'net_nfc_create_carrier_config_group',
    'net_nfc_create_data',
    'net_nfc_create_data_only',
    'net_nfc_create_handover_carrier',
    'net_nfc_create_handover_error_record',
    'net_nfc_create_handover_message',
    'net_nfc_create_ndef_message',
    'net_nfc_create_ndef_message_from_rawdata',
    'net_nfc_create_ndef_record_with_carrier_config',
    'net_nfc_create_rawdata_from_ndef_message',
    'net_nfc_create_record',
    'net_nfc_create_text_string_from_text_record',
    'net_nfc_create_text_type_record',
    'net_nfc_create_uri_string_from_uri_record',
    'net_nfc_create_uri_type_record',
    'net_nfc_duplicate_handover_carrier',
    'net_nfc_duplicate_target_info',
    'net_nfc_export_handover_to_ndef_message',
    'net_nfc_free_carrier_config',
    'net_nfc_free_carrier_group',
    'net_nfc_free_data',
    'net_nfc_free_handover_carrier',
    'net_nfc_free_handover_message',
    'net_nfc_free_ndef_message',
    'net_nfc_free_record',
    'net_nfc_get_card_emulation_mode_sync',
    'net_nfc_get_carrier_config_group',
    'net_nfc_get_carrier_config_group_property',
    'net_nfc_get_carrier_config_property',
    'net_nfc_get_data',
    'net_nfc_get_data_buffer',
    'net_nfc_get_data_length',
    'net_nfc_get_encoding_type_from_text_record',
    'net_nfc_get_handover_auxiliary_record',
    'net_nfc_get_handover_auxiliary_record_count',
    'net_nfc_get_handover_carrier',
    'net_nfc_get_handover_carrier_by_type',
    'net_nfc_get_handover_carrier_count',
    'net_nfc_get_handover_carrier_cps',
    'net_nfc_get_handover_carrier_record',
    'net_nfc_get_handover_carrier_type',
    'net_nfc_get_handover_random_number',
    'net_nfc_get_languange_code_string_from_text_record',
    'net_nfc_get_ndef_message_byte_length',
    'net_nfc_get_ndef_message_record_count',
    'net_nfc_get_record_by_index',
    'net_nfc_get_record_cf',
    'net_nfc_get_record_flags',
    'net_nfc_get_record_id',
    'net_nfc_get_record_il',
    'net_nfc_get_record_mb',
    'net_nfc_get_record_me',
    'net_nfc_get_record_payload',
    'net_nfc_get_record_sr',
    'net_nfc_get_record_tnf',
    'net_nfc_get_record_type',
    'net_nfc_get_tag_actual_data_size',
    'net_nfc_get_tag_handle',
    'net_nfc_get_tag_info_keys',
    'net_nfc_get_tag_info_value',
    'net_nfc_get_tag_max_data_size',
    'net_nfc_get_tag_ndef_message',
    'net_nfc_get_tag_ndef_state',
    'net_nfc_get_tag_ndef_support',
    'net_nfc_get_tag_type',
    'net_nfc_import_handover_from_ndef_message',
    'net_nfc_ndef_print_message',
    'net_nfc_release_tag_info',
    'net_nfc_remove_carrier_config_group',
    'net_nfc_remove_carrier_config_group_property',
    'net_nfc_remove_carrier_config_property',
    'net_nfc_remove_handover_auxiliary_record',
    'net_nfc_remove_handover_carrier_record',
    'net_nfc_remove_record_by_index',
    'net_nfc_retrieve_current_ndef_message',
    'net_nfc_search_record_by_type',
    'net_nfc_server_hce_ipc_send_to_server',
    'net_nfc_set_card_emulation_mode_sync',
    'net_nfc_set_data',
    'net_nfc_set_handover_carrier_cps',
    'net_nfc_set_handover_carrier_type',
    'net_nfc_set_record_id',
    'net_nfc_sign_ndef_message',
    'net_nfc_sign_records',
    'net_nfc_verify_signature_ndef_message',
    'net_nfc_verify_signature_records',
    'nfc_barcode_get_barcode',
    'nfc_common_check_app_permission',
    'nfc_common_convert_error_code',
    'nfc_common_get_bt_address_string',
    'nfc_common_get_focus_app_pid',
    'nfc_common_get_login_user',
    'nfc_common_get_rawdata_size',
    'nfc_common_is_initialized',
    'nfc_common_is_supported',
    'nfc_connection_handover_set_event_cb',
    'nfc_connection_handover_unset_event_cb',
    'nfc_handover_carrier_destroy',
    'nfc_handover_carrier_get_auxiliary_record',
    'nfc_handover_carrier_get_auxiliary_record_count',
    'nfc_handover_carrier_get_carrier_record',
    'nfc_handover_carrier_get_cps',
    'nfc_handover_carrier_get_handover_config',
    'nfc_handover_carrier_get_type',
    'nfc_handover_config_destroy',
    'nfc_handover_config_get_property',
    'nfc_handover_message_destroy',
    'nfc_handover_message_get_carrier',
    'nfc_handover_message_get_carrier_by_type',
    'nfc_handover_message_get_carrier_count',
    'nfc_handover_message_get_random_number',
    'nfc_handover_message_import_from_ndef_message',
    ...
    'nfc_manager_set_system_handler_enable_force',
    ...
    'nfc_se_add_route_for_aid_internal',
    'nfc_se_close_secure_element_internal',
    'nfc_se_disable_card_emulation',
    'nfc_se_enable_card_emulation',
    'nfc_se_foreach_registered_aids',
    'nfc_se_foreach_registered_handlers',
    'nfc_se_get_atr_internal',
    'nfc_se_get_card_emulation_mode',
    'nfc_se_get_conflict_handlers_internal',
    'nfc_se_get_registered_aids_count',
    'nfc_se_is_activated_handler_for_aid',
    'nfc_se_is_activated_handler_for_category',
    'nfc_se_open_secure_element_internal',
    'nfc_se_register_aid',
    'nfc_se_remove_route_for_aid_internal',
    'nfc_se_send_apdu_internal',
  ...
  'libcapi-network-stc.so.0': [
    'stc_deinitialize',
    'stc_exclude_restriction',
    'stc_foreach_restriction',
    'stc_foreach_stats',
    'stc_get_restriction',
    'stc_get_restriction_status',
    'stc_get_stats',
    'stc_get_total_stats',
    'stc_initialize',
    ...
    'stc_reset_stats',
    'stc_restriction_info_get_app_id',
    'stc_restriction_info_get_daily_limit',
    'stc_restriction_info_get_iface_name',
    'stc_restriction_info_get_iface_type',
    'stc_restriction_info_get_limit',
    'stc_restriction_info_get_monthly_limit',
    'stc_restriction_info_get_month_start_date',
    'stc_restriction_info_get_roaming_type',
    'stc_restriction_info_get_status',
    'stc_restriction_info_get_subscriber_id',
    'stc_restriction_info_get_warning_limit',
    'stc_restriction_info_get_weekly_limit',
  ...
  'libcapi-network-smartcard.so.0': [
    'channel_close',
    'channel_close_sync',
    'channel_destroy_instance',
    'channel_get_select_response',
    'channel_get_select_response_length',
    'channel_get_session',
    'channel_get_transmit_response',
    'channel_is_basic_channel',
    'channel_is_closed',
    'channel_select_next',
    'channel_transmit',
    'channel_transmit_sync',
    'reader_close_sessions',
    'reader_destroy_instance',
    'reader_get_name',
    'reader_get_se_service',
    'reader_is_secure_element_present',
    'reader_open_session',
    'reader_open_session_sync',
    'se_service_create_instance',
    'se_service_create_instance_sync',
    'se_service_create_instance_with_event_callback',
    'se_service_destroy_instance',
    'se_service_get_readers',
    'se_service_get_readers_count',
    'se_service_get_version',
    'se_service_is_connected',
    'se_service_set_event_handler',
    'se_service_shutdown',
    'se_service_unset_event_handler',
    'session_close',
    'session_close_channels',
    'session_close_sync',
    'session_destroy_instance',
    'session_get_atr',
    'session_get_atr_sync',
    'session_get_channel_count',
    'session_get_reader',
    'session_is_closed',
    'session_open_basic_channel',
    'session_open_basic_channel_sync',
    'session_open_logical_channel',
    'session_open_logical_channel_sync',
  ...
  'libcapi-telephony.so.0': [
    ...
    'telephony_network_get_signal_strength',

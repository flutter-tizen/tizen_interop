...
final Map<String, List<String>> tizen40Symbols = {
  ...
  'libdlog.so.0': [
    ...
    'log_config_get_int',
    'log_config_print_key',
    'log_config_print_out',
    'log_config_read',

...
final Map<String, List<String>> tizen55Symbols = {
  ...
  'libcapi-media-controller.so.0': [
    ...
    'mc_ipc_unregister_filter_listener',
  ...
  'libcapi-system-system-settings.so.0': [
    ...
    'system_setting_feature_check_accessibility_grayscale',
    'system_setting_feature_check_accessibility_negative',
    ...
    'system_setting_feature_check_wearable_profile',
  ...
  'libvc_manager.so': [
    ...
    'vc_mgr_dbus_request_disable_command_type',
    'vc_mgr_dbus_request_do_action',
    'vc_mgr_dbus_request_enable_command_type',

/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_ml_inference_single;
...
/// {@category 10.0/tizen}
class Tizen100CapiMlInferenceSingle {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiMlInferenceSingle(ffi.DynamicLibrary dynamicLibrary)
  ...
  /// - The `single` should be released using ml_single_close().
  ///
  /// **Parameters:**
  /// - `single` (out): This is the model handle opened.
  ...
  ///
  /// **Remarks:**
  /// - The `output` should be released using ml_tensors_data_destroy().
  ///
  /// **Parameters:**
  /// - `single` (in): The model handle to be inferred.
  /// - `input` (in): The input data to be inferred.
  /// - `output` (out): The allocated output buffer.
  ///
  /// **Returns:**
  /// - `0` on success. Otherwise a negative error value.
  ///
  ...
  /// **Remarks:**
  /// - The `output` should be released using ml_tensors_data_destroy().
  /// - The `out_info` should be released using ml_tensors_info_destroy().
  ///
  /// **Parameters:**
  /// - `single` (in): The model handle to be inferred.
  /// - `input` (in): The input data to be inferred.
  ...
  /// - `output` (out): The allocated output buffer.
  /// - `out_info` (out): The handle of output tensors information.
  ///
  /// **Returns:**
  /// - `0` on success. Otherwise a negative error value.
  ///

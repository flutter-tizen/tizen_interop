/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_media_audio_io;
...
/// {@category 10.0/tizen}
class Tizen100CapiMediaAudioIo {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiMediaAudioIo(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100CapiMediaAudioIo.fromLookup(

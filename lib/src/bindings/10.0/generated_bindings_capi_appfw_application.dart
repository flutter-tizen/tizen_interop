/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_appfw_application;
...
/// {@category 10.0/tizen}
class Tizen100CapiAppfwApplication {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiAppfwApplication(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100CapiAppfwApplication.fromLookup(
  ...
  ///
  /// **Remarks:**
  /// - The `event_handler` should be released using ui_app_remove_event_handler().
  ///
  /// **Parameters:**
  ...
  late final _ui_app_get_window_positionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int Function(
              ffi.Pointer<ffi.Int>,
              ffi.Pointer<ffi.Int>,
              ffi.Pointer<ffi.Int>,
              ffi.Pointer<ffi.Int>)>>('ui_app_get_window_position');
  late final _ui_app_get_window_position =
      _ui_app_get_window_positionPtr.asFunction<

/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_media_metadata_extractor;
...
/// {@category 10.0/tizen}
class Tizen100CapiMediaMetadataExtractor {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiMediaMetadataExtractor(ffi.DynamicLibrary dynamicLibrary)
  ...
  ///
  /// **Preconditions:**
  /// - Set the path or buffer to extract by calling metadata_extractor_set_path() or metadata_extractor_set_buffer().
  ///
  /// **See also:**
  /// - `metadata_extractor_create()`
  /// - `metadata_extractor_destroy()`
  ...
  /// Gets the artwork image of a media.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  /// Gets the synclyrics of a media.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///

/// {@category 10.0/tizen}
library tizen_interop_10_0.nsd_ssdp;
...
/// {@category 10.0/tizen}
class Tizen100NsdSsdp {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100NsdSsdp(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100NsdSsdp.fromLookup(
  ...
  ///
  /// **Parameters:**
  /// - `target` (in): The SSDP local service's target. It may be a device type or a service type specified in UPnP standard (https://openconnectivity.org/developer/specifications/upnp-resources/upnp/)
  ...
  /// Sets the USN (Unique Service Name) of SSDP local service. The USN format is specified in UPnP standard (https://openconnectivity.org/developer/specifications/upnp-resources/upnp/).
  ///
  /// **Since Tizen:**
  /// - 3.0
  ///
  ...
  ///
  /// **Remarks:**
  /// - The `ssdp_browser` should be released using ssdp_stop_browsing_service().
  ///
  /// **Parameters:**

/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_mediademuxer;
...
/// {@category 10.0/tizen}
class Tizen100CapiMediademuxer {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiMediademuxer(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100CapiMediademuxer.fromLookup(
  ...
  ///
  /// **Remarks:**
  /// - The `outbuf` should be released using media_packet_unref() function.

/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_media_controller;
...
/// {@category 10.0/tizen}
class Tizen100CapiMediaController {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiMediaController(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100CapiMediaController.fromLookup(

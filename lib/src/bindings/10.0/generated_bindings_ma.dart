...
class Tizen100Ma {
  ...
  Tizen100Ma(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100Ma.fromLookup(
  ...
  int ma_get_wakeup_info_wake_word(
    ...
    return _ma_get_wakeup_info_wake_word(
      wake_word,
    );
  }

  late final _ma_get_wakeup_info_wake_wordPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(ffi.Pointer<ffi.Pointer<ffi.Char>>)>>(
  ...
  int ma_get_wakeup_info_extra_data(
    ...
    ffi.Pointer<ffi.Pointer<ffi.Char>> extra_data_desc,
  ) {
    return _ma_get_wakeup_info_extra_data(
      extra_data,
      extra_data_length,
      extra_data_desc,
    );
  ...
  late final _ma_get_wakeup_info_extra_dataPtr = _lookup<
          ffi.NativeFunction<
  ...
  late final _ma_get_wakeup_info_extra_data =
      _ma_get_wakeup_info_extra_dataPtr.asFunction<

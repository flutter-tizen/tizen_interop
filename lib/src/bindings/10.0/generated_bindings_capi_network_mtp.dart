/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_network_mtp;
...
/// {@category 10.0/tizen}
class Tizen100CapiNetworkMtp {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiNetworkMtp(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100CapiNetworkMtp.fromLookup(
...
abstract class mtp_filetype_e {
  ...
  static const int MTP_FILETYPE_HEIF = 47;
}

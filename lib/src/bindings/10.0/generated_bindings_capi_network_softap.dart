/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_network_softap;
...
/// {@category 10.0/tizen}
class Tizen100CapiNetworkSoftap {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiNetworkSoftap(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100CapiNetworkSoftap.fromLookup(

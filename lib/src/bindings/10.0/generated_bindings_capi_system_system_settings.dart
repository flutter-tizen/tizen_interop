/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_system_system_settings;
...
/// {@category 10.0/tizen}
class Tizen100CapiSystemSystemSettings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiSystemSystemSettings(ffi.DynamicLibrary dynamicLibrary)
...
abstract class system_settings_key_e {
  ...
  /// < (bool) Indicates whether OOBE(Out Of Box Experience) is enabled on the device. (Since 10.0)
  static const int SYSTEM_SETTINGS_KEY_OOBE = 39;

  /// < max of system settings key
  static const int SYSTEM_SETTINGS_KEY_MAX = 40;
}

/// {@category 10.0/tizen}
library tizen_interop_10_0.appcore_agent;
...
/// {@category 10.0/tizen}
class Tizen100AppcoreAgent {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100AppcoreAgent(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100AppcoreAgent.fromLookup(
  ...
  /// - The `handler` should be released using service_app_remove_event_handler().
  ///
  /// **Parameters:**

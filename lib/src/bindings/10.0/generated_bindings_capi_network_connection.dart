/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_network_connection;
...
/// {@category 10.0/tizen}
class Tizen100CapiNetworkConnection {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiNetworkConnection(ffi.DynamicLibrary dynamicLibrary)
  ...
  ///
  /// This function releases all resources allocated for the given connection handle. should be called when the connection is no longer needed to prevent memory leaks and other potential issues.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves the type of the network currently being used for data connection. It returns an integer value representing the type of the network.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves the IP address associated with the network currently being used for data connection and address family. The retrieved IP address should be released using the free() function.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves the proxy address for the specified address family associated with the network currently being used for data connection. The retrieved proxy address should be released using free() after use.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves the MAC address of the specified network connection type (Wi-Fi or Ethernet). The caller is responsible for releasing the memory allocated for the MAC address using free().
  ///
  /// **Since Tizen:**
  /// - 2.4
  ///
  ...
  ///
  /// This function retrieves information about whether the current network connection is metered or not. A metered connection is typically one where data usage may be limited or charged for, such as a mobile network.
  ///
  /// **Since Tizen:**
  /// - 4.0
  ///
  ...
  ///
  /// This function retrieves the current state of the cellular connection. The state is returned as an enumeration value of the `connection_cellular_state_e` type.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves the current state of the Wi-Fi connection. This information can be used to determine the status of the Wi-Fi network connection.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function sets a callback function to receive notifications about changes in the Internet availability status of the connection. When the Internet availability state changes, the provided callback function will be invoked with the new state and the user data supplied during the registration.
  ///
  /// **Since Tizen:**
  /// - 5.5
  ///
  ...
  ///
  /// This function removes the previously set callback for monitoring changes in the Internet state of the connection. After calling this function, the callback will no longer be invoked when the Internet state changes.
  ///
  /// **Since Tizen:**
  /// - 5.5
  ///
  ...
  ///
  /// This function retrieves the current state of the ethernet cable connected to the device. The possible states include whether the cable is attached or detached.
  ///
  /// **Since Tizen:**
  /// - 2.4
  ///
  ...
  ///
  /// This function retrieves the DHCP state of the network currently being used for data connection. The DHCP state indicates whether the interface has started to obtained an IP address via DHCP or not.
  ///
  /// **Since Tizen:**
  /// - 8.0
  ///
  ...
  /// Sets callback for ethernet cable is plugged `[in/out]` event.
  ///
  /// This function registers a callback function to be invoked when the state of the ethernet cable changes. It allows you to monitor whether the ethernet cable is plugged in or out.
  ///
  /// **Since Tizen:**
  /// - 4.0
  ///
  ...
  ///
  /// This function retrieves the current state of the Bluetooth connection. Possible states include disconnected, connected, and deactivated.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function registers a callback function to be invoked when the type of the current network connection changes. The registered callback will be called with user data provided during registration whenever the connection type changes.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function removes the callback function that was previously registered using connection_set_type_changed_cb(). After calling this function, the connection_type_changed_cb callback will no longer be called when the connection type changes.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function removes the callback function that was previously set to be called when the IP address changes for the connection. After calling this function, no further notifications will be sent about IP address changes.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function removes the callback function that was previously set using connection_set_proxy_address_changed_cb(). After calling this function, the proxy address change events will no longer be delivered to the application.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function registers a callback function to receive notifications whenever the DHCP state changes for the connection. When the DHCP state changes, the registered callback function will be invoked with the new DHCP state and the provided user data.
  ///
  /// **Since Tizen:**
  /// - 8.0
  ///
  ...
  ///
  /// This function adds a new cellular profile to the profile list to be used for cellular connection. The profile must be created using connection_profile_create() and should be of the cellular type. The caller must have the necessary privileges to perform this operation.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves an iterator to enumerate all the profiles of a given type from the profile list. The caller is responsible for releasing the iterator using the connection_destroy_profile_iterator() function after it is no longer needed.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function moves the given profile iterator to the next position and retrieves the profile handle at that position. If the end of the iteration is reached, the function returns CONNECTION_ERROR_ITERATOR_END. The retrieved profile handle will be automatically destroyed when the profile iterator is destroyed. To continue using the profile handle after the iterator is destroyed, make a copy of it.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  /// **Remarks:**
  /// - The `profile` will be destroyed automatically when the profile iterator is destroyed.
  ...
  ///
  /// This function checks if there is another profile available to iterate over using the given profile iterator handle. If the next element exists, it returns true; otherwise, it returns false. The specific error code can be obtained using the get_last_result() method. Error codes are described in Exception section.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function destroys the given profile iterator handle and releases all its resources. After calling this function, the profile iterator handle becomes invalid, and you cannot use it to perform any operations.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves the default profile that provides the specified cellular service type. The caller must release the returned profile handle using connection_profile_destroy().
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function sets the default profile for the specified cellular service type. It requires both network.profile and network.get privileges. The function only permits `CONNECTION_CELLULAR_SERVICE_TYPE_INTERNET` and `CONNECTION_CELLULAR_SERVICE_TYPE_PREPAID_INTERNET` as valid service types. If successful, it returns `CONNECTION_ERROR_NONE`; otherwise, it returns an appropriate error code.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function sets the default profile for a specified cellular service type asynchronously. It requires both network.profile and network.get privileges. Only `CONNECTION_CELLULAR_SERVICE_TYPE_INTERNET` and `CONNECTION_CELLULAR_SERVICE_TYPE_PREPAID_INTERNET` are allowed as the service type. The function returns an integer value indicating the result of the operation. If successful, it returns `CONNECTION_ERROR_NONE`; otherwise, it returns one of the other error codes.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function closes the connection of a specified profile and releases all resources associated with it. After closing the profile, the corresponding callback function is invoked to notify the completion of the operation.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function resets the cellular profiles. It requires both network.profile and network.get privileges. The type of reset can be specified using the 'type' parameter, and the subscriber identity module ID to reset can be provided using the 'id' parameter. The callback function and user data are used for asynchronous operation handling.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function retrieves the specified statistics information for the given connection type. It supports only `CONNECTION_TYPE_WIFI` and `CONNECTION_TYPE_CELLULAR` types.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
  ...
  ///
  /// This function resets the specified statistics information for a given connection type. Supported connection types include `CONNECTION_TYPE_WIFI` and `CONNECTION_TYPE_CELLULAR`.
  ///
  /// **Since Tizen:**
  /// - 2.3
  ///
...
///
/// This callback function is invoked when the Internet state of the current connection changes. It provides information about the new state of the connection and allows you to handle any necessary actions based on the updated state.
///
/// **Since Tizen:**
/// - 5.5
///
...
///
/// This callback function is invoked when the type of the network connection changes. It provides information about the connection type changes and allows you to handle the change accordingly.
///
/// **Since Tizen:**
/// - 2.3
///
...
///
/// This callback function is called when the IP address for IPv4 or IPv6 changes. The addresses provided within this callback are valid only during the execution of the callback. If you need to use these addresses outside of the callback, you must make a copy of them.
///
/// **Since Tizen:**
/// - 2.3
///
...
///
/// This callback function is invoked when the DHCP state changes for a given network interface. It provides information about DHCP state changes, the network interface associated with the state change, and the result of the DHCP operation.
///
/// **Since Tizen:**
/// - 8.0
///
...
///
/// This callback function is invoked after the asynchronous operation of setting a default cellular service profile is completed. It provides the result of the operation and any user data that was passed during the invocation of connection_set_default_cellular_service_profile_async().
///
/// **Since Tizen:**
/// - 2.3
///
...
///
/// This callback function is invoked when the asynchronous operation of opening a network profile is completed. It provides the result of the operation and any user data that was passed during the call to connection_open_profile(). The application can use this callback to handle the result of the profile opening process.
///
/// **Since Tizen:**
/// - 2.3
///
...
///
/// This callback function is invoked when the connection_close_profile() function has completed its execution. It receives the result of the operation and any user data that was passed to the connection_close_profile() function.
///
/// **Since Tizen:**
/// - 2.3
///
...
///
/// This callback function is invoked when the connection_reset_profile() function completes its operation. It receives the result of the operation and the user data that was passed to the connection_reset_profile() function.
///
/// **Since Tizen:**
/// - 2.3
///
...
///
/// This callback function is invoked when iterating through the list of IPv6 addresses associated with a network interface. It provides each IPv6 address as a character string and allows the caller to perform custom operations on each address.
///
/// **Since Tizen:**
/// - 4.0
///

/// {@category 10.0/tizen}
library tizen_interop_10_0.wifi_direct;
...
/// {@category 10.0/tizen}
class Tizen100WifiDirect {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100WifiDirect(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100WifiDirect.fromLookup(
  ...
  /// - `wifi_direct_discovery_state_changed_cb()` Here is an example of the usage:
  ///
  /// ```
  /// #include <stdio.h>
  /// #include <wifi_direct.h>
  ...
  int wifi_direct_set_discovery_state_changed_cb(
    wifi_direct_discovery_state_changed_cb cb,
    ffi.Pointer<ffi.Void> user_data,
  ) {
  ...
  late final _wifi_direct_set_discovery_state_changed_cbPtr = _lookup<
          ffi.NativeFunction<
              ffi.Int Function(wifi_direct_discovery_state_changed_cb,
  ...
  late final _wifi_direct_set_discovery_state_changed_cb =
      _wifi_direct_set_discovery_state_changed_cbPtr.asFunction<
          int Function(
              wifi_direct_discovery_state_changed_cb, ffi.Pointer<ffi.Void>)>();
  ...
  ///
  /// **Postconditions:**
  /// - wifi_direct_discovery_state_changed_cb() will be invoked.
  ///
  /// **See also:**
  /// - `wifi_direct_activate()`
  ...
  /// - `wifi_direct_activate()`
  /// - `wifi_direct_cancel_discovery()`
  /// - `wifi_direct_discovery_state_changed_cb()`
  ...
  ///
  /// **Parameters:**
  /// - `max` (out): The max number of clients
  ///
  /// **Returns:**
  /// - `0` on success, otherwise a negative error value
  ///
...
/// - `wifi_direct_unset_discovery_state_changed_cb()`
/// @nodoc
typedef wifi_direct_discovery_state_changed_cb = ffi.Pointer<
    ffi.NativeFunction<wifi_direct_discovery_state_changed_cbFunction>>;
/// @nodoc
typedef wifi_direct_discovery_state_changed_cbFunction = ffi.Void Function(
    ffi.Int error_code,
    ffi.Int32 discovery_state,
    ffi.Pointer<ffi.Void> user_data);
/// @nodoc
typedef Dartwifi_direct_discovery_state_changed_cbFunction = void Function(

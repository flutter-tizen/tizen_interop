/// {@category 10.0/tizen}
library tizen_interop_10_0.capi_media_player;
...
/// {@category 10.0/tizen}
class Tizen100CapiMediaPlayer {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  Tizen100CapiMediaPlayer(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  Tizen100CapiMediaPlayer.fromLookup(
  ...
  /// Sets the streaming buffering time. 4.0
  ///
  /// **Parameters:**
  /// - `player` (in): The handle to the media player
  ...
  /// - `PLAYER_ERROR_INVALID_PARAMETER`: Invalid parameter
  /// - `PLAYER_ERROR_INVALID_STATE`: Invalid state
  /// - `PLAYER_ERROR_INVALID_OPERATION`: Invalid operation (since 5.5)
  ///
  /// **Preconditions:**
  /// - The player state must be `PLAYER_STATE_IDLE`.
  ///
...
abstract class _media_format_mimetype_e {
  ...
  /// < media format mime type is BGR888, VIDEO, (Since 7.0)
  static const int MEDIA_FORMAT_BGR888 = 570434993;

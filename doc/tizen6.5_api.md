...
| Applicatoin Framework / Application | tizenCapiAppfwApplication | app_efl_exit |
|  |  | app_efl_main |
|  |  | app_exit |
...
| Application Framework / Application / App Common, Resource Manager | tizenCapiAppfwAppCommon | app_convert_appcore_rm |
|  |  | app_error |
...
| Application Framework / Shortcut | tizenShortcut | add_to_home_dynamicbox |
...
| Machine Learning | tizenCapiNnstreamer | ml_check_element_availability |
...
|  |  | camera_device_manager_get_device_list |
...
|  |  | mv_inference_configure_input_info_open |
|  |  | mv_inference_configure_model_open |
|  |  | mv_inference_configure_output_info_open |
|  |  | mv_inference_configure_output_open |
|  |  | mv_inference_configure_post_process_info_open |
|  |  | mv_inference_create |
...
|  |  | stt_parser_set_time_info |
|  |  | stt_parser_unload_config |
| UIX / TTS | tizenTts | rpc_port_array_char_clone |
|  |  | rpc_port_array_char_create |
|  |  | rpc_port_array_char_destroy |
|  |  | rpc_port_array_char_get_array_chars |
|  |  | rpc_port_array_char_set_array_chars |
...
|  |  | rpc_port_tts_notify_cb_create |
|  |  | rpc_port_tts_notify_cb_destroy |
|  |  | tts_add_pcm |
|  |  | tts_add_text |
...
|  |  | tts_core_notify_state_changed_async |
...
| UIX / TTS Engine | tizenTtsEngine | rpc_port_array_char_clone |
|  |  | rpc_port_array_char_create |
|  |  | rpc_port_array_char_destroy |
|  |  | rpc_port_array_char_get_array_chars |
|  |  | rpc_port_array_char_set_array_chars |
...
|  |  | rpc_port_tts_notify_cb_clone |
|  |  | rpc_port_tts_notify_cb_destroy |
|  |  | rpc_port_tts_notify_cb_invoke |
|  |  | rpc_port_tts_notify_cb_set_port |
|  |  | tts_config_check_default_engine_is_valid |
|  |  | tts_config_check_default_voice_is_valid |
|  |  | tts_config_mgr_finalize |
|  |  | tts_config_mgr_get_auto_voice |
...
|  |  | tts_parser_unload_config |
|  |  | tts_tag |
| UIX / Voice control | tizenVc | vc_auth_cancel |
|  |  | vc_auth_disable |
|  |  | vc_auth_enable |
|  |  | vc_auth_get_state |
...
|  |  | vcd_dbus_server_mgr_set_audio_streaming_mode |
...
|  |  | vc_mgr_dbus_request_set_audio_streaming_mode |

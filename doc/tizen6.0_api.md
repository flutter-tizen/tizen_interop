...
| Application Framework / RPC Port | tizenRpcPort | rpc_port_parcel_burst_read |
...
| Multimedia / Media Tool | tizenCapiMediaTool | media_format_channel_positions_from_mask |
...
|  |  | tone_player_stop |
| Multimedia / WAV Player | tizenCapiMediaWavPlayer | wav_player_start_loop |
...
| Network / DNSSD | tizenNsdDnsSd | dnssd_create_local_service |
|  |  | dnssd_deinitialize |
...
| System / Diagnostics | tizenDiagnostics | dbus_get_file_from_report |
|  |  | dbus_signal_cleanup |
|  |  | dbus_signal_create |
|  |  | dbus_subscribe |
|  |  | dbus_unsubscribe |
...
| System / Dlog | tizenDlog | connect_sock |
|  |  | create_glued_string |
|  |  | create_hash |
|  |  | create_pipe_message |
|  |  | dlog_print |
...
| UIX / TTS Engine | tizenTtsEngine | tts_config_check_default_engine_is_valid |
|  |  | tts_config_check_default_voice_is_valid |
|  |  | tts_config_mgr_finalize |
|  |  | tts_config_mgr_get_auto_voice |
|  |  | tts_config_mgr_get_bg_volume_ratio |
...
| UIX / Voice control engine | tizenVcEngine | audio_streaming_cb |
|  |  | vc_cmd_create |
|  |  | vc_cmd_destroy |
|  |  | vc_cmd_get_appid |
|  |  | vc_cmd_get_command |

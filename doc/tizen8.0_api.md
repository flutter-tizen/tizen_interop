...
| Applicatoin Framework / Application (include i18n) | tizenCapiAppfwApplication | app_efl_exit |
|  |  | app_efl_main |
|  |  | app_exit |
...
| Machine Learning / Service | tizenCapiMlService | machinelearning_service_model_call_activate |
...
|  |  | mx_unprepare |
|  |  | mx_write_sample |
| Multimedia / Media Streamer | tizenCapiMediaStreamer | media_streamer_create |
...
| Multimedia / Media Vision Common | tizenMvCommon | mv_create_engine_config |
|  |  | mv_create_source |
...
| Multimedia / StreamRecorder | tizenCapiMediaStreamrecorder | streamrecorder_cancel |
...
|  |  | wav_player_stop |
| Multimedia / WebRTC | tizenCapiMediaWebrtc | webrtc_add_ice_candidate |
...
|  |  | feedback_get_theme_index_internal |
|  |  | feedback_initialize |
...
|  |  | feedback_set_theme_index_internal |
|  |  | feedback_stop |

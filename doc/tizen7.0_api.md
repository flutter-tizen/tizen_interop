...
| Machine Learning | tizenCapiMlCommon | ml_error |
|  |  | ml_option_create |
|  |  | ml_option_destroy |
|  |  | ml_option_set |
|  |  | ml_strerror |
...
| Machine Learning / Service | tizenCapiMlService | machinelearning_service_model_call_delete |
...
| Multimedia / Thumbnail Util | tizenCapiMediaThumbnailUtil | thumbnail_util_cancel |
...
| System / Peripheral IO | tizenCapiSystemPeripheralIo | gpio_legacy_cleanup |
...
| System / Sensor | tizenCapiSystemSensor | clamp |
|  |  | getAngleChange |
|  |  | getDeclination |
|  |  | getInclination |
|  |  | getRotationMatrix |
...
| UI / Clipboard History Manager | tizenCbhm | cbhm_close_service |
|  |  | cbhm_hide |

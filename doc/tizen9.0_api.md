...
| Account / Sync Manager | tizenCoreSyncClient | sync_adapter_set_callbacks |
...
| Application Framework / Application (include i18n) | tizenCapiAppfwApplication | app_get_device_orientation |
...
| Application Framework / Application / App Common, Resource Manager | tizenCapiAppfwAppCommon | app_event_get_device_orientation |
...
| Application Framework / Bundle | tizenBundle | bundle_add_byte |
...
| Application Framework / RPC Port | tizenRpcPort | rpc_port_disconnect |
...
| Machine Learning / Trainer | tizenCapiNntrainer | ml_train_dataset_add_file |
...
| Multimedia / Media Codec | tizenCapiMediaCodec | mediacodec_configure_from_media_format |
|  |  | mediacodec_create |
|  |  | mediacodec_destroy |
...
| Multimedia / Media Demuxer | tizenCapiMediademuxer | mediademuxer_create |
...
| Multimedia / Media Muxer | tizenCapiMediamuxer | mediamuxer_add_track |
...
| Multimedia / Media Vision Surveillance | tizenMvSurveillance | mv_surveillance_event_trigger_create |
...
| Multimedia / Player | tizenCapiMediaPlayer | player_360_get_direction_of_view |
...
| Multimedia / Screen Mirroring | tizenCapiMediaScreenMirroring | scmirroring_sink_connect |
...
| Network / Bluetooth | tizenCapiNetworkBluetooth | bt_adapter_foreach_bonded_device |
...
| Network / Intelligent Network Monitoring | tizenCapiNetworkInm | inm_arp_request_get_packet_interval |
...
| Network / NFC | tizenCapiNetworkNfc | nfc_hce_send_apdu_response |
...
| Network / Smart Traffic Control | tizenCapiNetworkStc | stc_deinitialize |
...
|  |  | vpnsvc_write |
| Network / WI-Fi Manager | tizenCapiNetworkWifiManager | wifi_manager_activate |
...
| Network / Wi-Fi Direct | tizenWifiDirect | wifi_direct_activate |
...
|  |  | yaca_verify_update |
|  |  | yaca_zalloc |
| Social / Calendar | tizenCalendarService2 | calendar_connect |
...
| System / Device | tizenCapiSystemDevice | device_add_callback |
...
| System / Sensor | tizenCapiSystemSensor | sensor_add_provider |
...
| System / T-trace | tizenTtrace | trace_async_begin |
|  |  | trace_async_end |
|  |  | trace_begin |
|  |  | trace_end |
...
| UI / TBM Surface | tizenTbm | tbm_surface_create |
|  |  | tbm_surface_destroy |
...
| UIX / STT Engine | tizenSttEngine | stte_main |
|  |  | stte_send_error |
|  |  | stte_send_result |
...
| UIX / TTS | tizenTts | tts_add_silent_utterance |
|  |  | tts_add_text |
...
| UIX / TTS Engine | tizenTtsEngine | ttse_get_activated_mode |
...
|  |  | ttse_terminate |
| UIX / Voice control | tizenVc | vc_cmd_create |
|  |  | vc_cmd_destroy |
|  |  | vc_cmd_get_command |
|  |  | vc_cmd_get_format |
|  |  | vc_cmd_get_type |

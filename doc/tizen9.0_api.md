...
| Account / FIDO Client | tizenFidoClient | fido_authenticator_foreach_attestation_type |
...
| Account / OAuth 2.0 | tizenOauth2 | oauth2_error_get_code |
...
| Account / Sync Manager | tizenCoreSyncClient | bundle_iterate_cb |
|  |  | get_interval |
|  |  | marshal_bundle |
...
| Application Framework / Application (include i18n) | tizenCapiAppfwApplication | app_efl_exit |
|  |  | app_efl_main |
|  |  | app_exit |
...
|  |  | ui_app_exit |
|  |  | ui_app_get_window_position |
|  |  | ui_app_main |
|  |  | ui_app_remove_event_handler |
| Application Framework / Application / Alarm | tizenCapiAppfwAlarm | alarm_cancel |
|  |  | alarm_cancel_all |
...
| Application Framework / Application / App Common, Resource Manager | tizenCapiAppfwAppCommon | app_error |
...
|  |  | app_control_get_window_position |
...
|  |  | app_control_send_launch_request_async_with_timeout |
|  |  | app_control_send_launch_request_sync |
|  |  | app_control_send_launch_request_with_timeout |
...
|  |  | app_control_set_window_position |
|  |  | app_control_to_bundle |
|  |  | app_control_unset_auto_restart |
|  |  | app_control_unset_defapp |
| Application Framework / Application / App Control URI | tizenCapiAppfwAppControlUri | app_control_uri_builder_add_path |
...
| Application Framework / Application / Event | tizenCapiAppfwEvent | event_add_event_handler |
|  |  | event_keep_last_event_data |
|  |  | event_publish_app_event |
|  |  | event_publish_trusted_app_event |
|  |  | event_remove_event_handler |
| Application Framework / Application / Job scheduler | tizenCapiAppfwJobScheduler | job_info_add_trigger_event |
|  |  | job_info_clone |
|  |  | job_info_create |
|  |  | job_info_destroy |
|  |  | job_info_get_job_id |
...
| Application Framework / Application / Preference | tizenCapiAppfwPreference | preference_foreach_item |
...
| Application Framework / Application Manager | tizenCapiAppfwAppManager | app_context_clone |
|  |  | app_context_destroy |
...
| Application Framework / Badge | tizenBadge | badge_add |
...
|  |  | rpc_port_proxy_badge_lem_Badge_connect |
|  |  | rpc_port_proxy_badge_lem_Badge_disconnect |
|  |  | rpc_port_proxy_badge_lem_Badge_invoke_callback |
|  |  | rpc_port_proxy_badge_lem_Badge_send_result |
| Application Framework / Bundle | tizenBundle | bundle_add |
|  |  | bundle_add_byte |
...
|  |  | bundle_to_json |
| Application Framework / Cion | tizenCion | cion_client_add_connection_result_cb |
...
| Application Framework / Data Control | tizenDataControl | data_control_add_data_change_cb |
...
| Application Framework / Message Port | tizenMessagePort | message_port_add_registered_cb |
...
| Application Framework / Notification | tizenNotification | notification_add_button |
...
|  |  | notification_get_check_box_checked |
...
|  |  | notification_register_do_not_disturb_app |
...
|  |  | notification_unregister_do_not_disturb_app |
...
| Application Framework / Notification EX | tizenNotificationEx | noti_ex_action_app_control_create |
...
| Application Framework / Package Manager | tizenCapiAppfwPackageManager | package_archive_info_create |
...
| Application Framework / RPC Port | tizenRpcPort | rpc_port_deregister_proc_info |
|  |  | rpc_port_disconnect |
...
|  |  | rpc_port_write |
| Application Framework / Service Application | tizenAppcoreAgent | service_app_add_event_handler |
...
| Application Framework / Tizen Core | tizenTizenCore | tizen_core_add_channel |
...
|  |  | download_get_cache |
|  |  | download_get_cache_lifecycle |
|  |  | download_get_cache_max_size |
|  |  | download_get_cache_path |
...
|  |  | download_reset_all_cache |
|  |  | download_reset_cache |
|  |  | download_set_auto_download |
|  |  | download_set_cache |
|  |  | download_set_cache_lifecycle |
|  |  | download_set_cache_max_size |
|  |  | download_set_cache_path |
...
| Content / Mime Type | tizenCapiContentMimeType | mime_type_get_file_extension |
|  |  | mime_type_get_mime_type |
|  |  | mime_type_get_mime_type_for_data |
|  |  | mime_type_get_mime_type_for_file |
| Content / Media Content | tizenCapiContentMediaContent | audio_meta_clone |
|  |  | audio_meta_destroy |
...
|  |  | book_meta_clone |
|  |  | book_meta_destroy |
|  |  | book_meta_get_author |
|  |  | book_meta_get_date |
|  |  | book_meta_get_media_id |
|  |  | book_meta_get_path_with_keyword |
|  |  | book_meta_get_publisher |
|  |  | book_meta_get_subject |
|  |  | image_meta_clone |
|  |  | image_meta_destroy |
...
| Location / Geofence Manager | tizenCapiGeofenceManager | geofence_create_bluetooth |
...
| Location / Location Manager | tizenCapiLocationManager | gps_status_foreach_last_satellites_in_view |
...
| Machine Learning | tizenCapiMlCommon | ml_api_get_version |
...
| Machine Learning / Pipeline | tizenCapiNnstreamer | ml_check_element_availability |
...
| Machine Learning / Service | tizenCapiMlService | ml_service_destroy |
...
|  |  | ml_service_start |
|  |  | ml_service_stop |
| Machine Learning / Single | tizenCapiMlInferenceSingle | ml_check_nnfw_availability |
...
| Machine Learning / Trainer | tizenCapiNntrainer | ml_tizen_get_feature_enabled |
...
|  |  | ml_train_dataset_set_property_for_mode_with_single_param |
...
|  |  | ml_train_lr_scheduler_set_property_with_single_param |
|  |  | ml_train_model_add_layer |
|  |  | ml_train_model_compile |
|  |  | ml_train_model_compile_with_single_param |
...
|  |  | ml_train_model_load |
|  |  | ml_train_model_run |
|  |  | ml_train_model_run_with_single_param |
|  |  | ml_train_model_save |
...
| Messaging / Email | tizenCapiMessagingEmail | email_add_attach |
|  |  | email_add_recipient |
...
| Messaging / Push | tizenPush | push_connect |
|  |  | push_deregister |
...
| Multimedia / Audio I/O | tizenCapiMediaAudioIo | audio_in_create |
|  |  | audio_in_destroy |
|  |  | audio_in_drop |
|  |  | audio_in_flush |
...
|  |  | audio_io_append_effect_method_chain_builder |
|  |  | audio_io_apply_effect_method |
|  |  | audio_io_apply_effect_method_chain |
|  |  | audio_io_apply_effect_method_with_reference |
|  |  | audio_io_build_effect_method_chain |
|  |  | audio_io_create_acoustic_echo_canceller |
|  |  | audio_io_create_auto_gain_control |
|  |  | audio_io_create_effect_method_chain_builder |
|  |  | audio_io_create_noise_suppressor |
|  |  | audio_io_destroy_effect_method |
|  |  | audio_io_destroy_effect_method_chain |
|  |  | audio_io_destroy_effect_method_chain_builder |
|  |  | audio_out_create |
...
|  |  | cpp_audio_out_write |
| Multimedia / Camera | tizenCapiMediaCamera | camera_add_device_state_changed_cb |
...
|  |  | camera_is_supported_media_packet_preview_internal_cb |
...
|  |  | camera_unset_media_packet_preview_internal_cb |
|  |  | camera_unset_preview_cb |
|  |  | camera_unset_state_changed_cb |
| Multimedia / Image Util | tizenCapiMediaImageUtil | image_util_agif_encode_add_frame |
...
| Multimedia / Media Codec | tizenCapiMediaCodec | codec_type_to_simple_enumeration |
...
|  |  | mediacodec_create |
|  |  | mediacodec_destroy |
|  |  | mediacodec_enable_extra_video_converter |
...
|  |  | mediacodec_resource_allocate |
|  |  | mediacodec_resource_create |
|  |  | mediacodec_resource_deallocate |
|  |  | mediacodec_resource_release |
...
| Multimedia / Media Controller | tizenCapiMediaController | mc_client_create |
|  |  | mc_client_destroy |
...
| Multimedia / Media Demuxer | tizenCapiMediademuxer | custom_mediademxer_port_register |
...
| Multimedia / Media Muxer | tizenCapiMediamuxer | custom_mediamuxer_port_register |
...
|  |  | mx_unprepare |
|  |  | mx_write_sample |
| Multimedia / Media Tool | tizenCapiMediaTool | media_bridge_add_sink |
|  |  | media_bridge_create |
...
| Multimedia / Media Vision 3D | tizenMv3d | mv_3d_configure |
|  |  | mv_3d_create |
|  |  | mv_3d_destroy |
...
| Multimedia / Media Vision BarCode | tizenMvBarcodeDetector | mv_barcode_detect |
|  |  | mv_barcode_detect_open |
|  | tizenMvBarcodeGenerator | mv_barcode_generate_image |
|  |  | mv_barcode_generate_source |
| Multimedia / Media Vision Common | tizenMvCommon | mv_check_feature_key |
...
| Multimedia / Media Vision Object Detection | tizenMvObjectDetection | mv_face_detection_configure |
...
| Multimedia / Media Vision Face | tizenMvFace | mv_face_detect |
|  |  | mv_face_detect_open |
...
|  |  | mv_face_track_open |
| Multimedia / Media Vision Face Recognition | tizenMvFaceRecognition | mv_face_recognition_create |
...
| Multimedia / Media Vision Pose Landmark Detection | tizenMvLandmarkDetection | mv_facial_landmark_configure |
...
| Multimedia / Media Vision Image | tizenMvImage | mv_image_object_clone |
...
|  |  | mv_image_track_open |
| Multimedia / Media Vision Image Classification | tizenMvImageClassification | mv_image_classification_configure |
...
| Multimedia / Media Vision Inference | tizenMvInference | mv_inference_configure |
|  |  | mv_inference_create |
...
| Multimedia / Media Vision Roi tracker | tizenMvRoiTracker | mv_roi_tracker_configure |
...
| Multimedia / Media Vision Surveillance | tizenMvSurveillance | mv_absdiff |
|  |  | mv_apply_mask |
|  |  | mv_get_mask_buffer |
...
| Multimedia / Media Editor | tizenCapiMediaEditor | mediaeditor_activate_layer |
...
| Multimedia / Metadata Editor | tizenCapiMediaMetadataEditor | metadata_editor_append_picture |
...
| Multimedia / Metadata Extractor | tizenCapiMediaMetadataExtractor | metadata_extractor_create |
...
| Multimedia / Player | tizenCapiMediaPlayer | client_get_api_timeout |
...
| Multimeida / Radio | tizenCapiMediaRadio | radio_create |
|  |  | radio_destroy |
...
| Multimedia / Recorder | tizenCapiMediaRecorder | recorder_add_device_state_changed_cb |
...
| Multimedia / Screen Mirroring | tizenCapiMediaScreenMirroring | scmirroring_primary_sink_connect |
...
| Multimedia / Sound Manager | tizenCapiMediaSoundManager | sound_manager_acquire_focus |
...
|  |  | sound_manager_get_current_media_playback_device_id |
...
|  |  | sound_manager_get_rpi_playback_route |
...
| Multimedia / Sound Pool | tizenCapiMediaSoundPool | sound_pool_activate |
|  |  | sound_pool_create |
...
| Multimedia / Thumbnail Util | tizenCapiMediaThumbnailUtil | thumbnail_util_extract_to_buffer |
|  |  | thumbnail_util_extract_to_file |
| Multimedia / Tone Player | tizenCapiMediaTonePlayer | tone_player_start_new |
|  |  | tone_player_stop |
| Multimedia / WAV Player | tizenCapiMediaWavPlayer | wav_player_play_simple |
|  |  | wav_player_start_loop |
|  |  | wav_player_start_loop_stop_others |
|  |  | wav_player_start_new |
|  |  | wav_player_stop |
| Network / Application Service Platform | tizenAsp | asp_advert_add_info |
...
| Network / Bluetooth | tizenCapiNetworkBluetooth | bt_a2dp_set_content_protection |
...
|  |  | bt_gatt_client_set_phy_update_cb |
...
|  |  | bt_gatt_server_set_phy_update_cb |
...
|  |  | bt_gatt_server_unset_phy_update_cb |
...
| Network / Connection | tizenCapiNetworkConnection | connection_add_profile |
|  |  | connection_add_route |
|  |  | connection_add_route_entry |
|  |  | connection_add_route_ipv6 |
|  |  | connection_clear_ntp_server |
...
| Network / DNSSD | tizenNsdDnsSd | dnssd_browse_service |
...
| Network / HTTP | tizenCapiNetworkHttp | http_deinit |
|  |  | http_init |
|  |  | http_session_create |
...
| Network / Intelligent Network Monitoring | tizenCapiNetworkInm | inm_ap_foreach_vsie |
...
|  |  | inm_handle_set_dns_state_changed_cb |
|  |  | inm_handle_set_eth_cable_cb |
|  |  | inm_handle_set_eth_cb |
|  |  | inm_handle_set_gateway_state_changed_cb |
...
|  |  | inm_handle_unset_dns_state_changed_cb |
|  |  | inm_handle_unset_eth_cable_cb |
|  |  | inm_handle_unset_eth_cb |
|  |  | inm_handle_unset_gateway_state_changed_cb |
...
|  |  | inm_http_online_check |
|  |  | inm_initialize |
|  |  | inm_invoke_gdbus_get_state |
|  |  | inm_invoke_gdbus_http_online_check |
...
|  |  | inm_set_default_dns_state_changed_cb |
...
| Network / IoTCon | tizenIotcon | iotcon_add_generated_pin_cb |
...
| Network / MTP | tizenCapiNetworkMtp | mtp_add_mtp_event_cb |
|  |  | mtp_db_deinit |
...
| Network / SSDP | tizenNsdSsdp | ssdp_create_local_service |
|  |  | ssdp_deinitialize |
...
| Network / Smart Traffic Control | tizenCapiNetworkStc | stc_add_restriction_rule_to_list |
|  |  | stc_deinitialize |
...
| Network / SoftAP | tizenCapiNetworkSoftap | softap_client_clone |
...
| Network / VPN Service | tizenCapiVpnsvc | vpnsvc_add_dns_server |
|  |  | vpnsvc_add_route |
...
|  |  | vpnsvc_write |
| Network / WI-Fi Manager | tizenCapiNetworkWifiManager | net_wifi_flush_bss |
...
|  |  | wifi_manager_config_get_passphrase |
...
|  |  | wifi_manager_config_reset_configurations |
...
|  |  | wifi_manager_get_autoscan_interval |
...
|  |  | wifi_manager_get_power_save_mode |
|  |  | wifi_manager_get_power_save_state |
|  |  | wifi_manager_get_preassoc_mac_policy |
|  |  | wifi_manager_get_random_mac_lifetime |
|  |  | wifi_manager_get_scan_band |
...
|  |  | wifi_manager_set_dhcp_state_changed_cb |
...
|  |  | wifi_manager_set_power_save_state |
...
|  |  | wifi_manager_unset_dhcp_state_changed_cb |
...
| Network / Wi-Fi Aware | tizenCapiNetworkWifiAware | wifi_aware_data_path_close |
...
| Network / Wi-Fi Direct | tizenWifiDirect | wifi_direct_accept_connection |
...
| Security / CSR | tizenCsrClient | csr_cs_cancel_scanning |
...
| Security / Device Certificate Manager | tizenDeviceCertificateManager | dcm_create_key_context |
|  |  | dcm_create_signature |
|  |  | dcm_free_key_context |
|  |  | dcm_get_certificate_chain |
|  |  | dcm_get_key_bit_length |
|  |  | dcm_get_key_type |
| Security / Device Policy Manager | tizenDpm | dpm_add_policy_changed_cb |
|  |  | dpm_add_signal_cb |
...
|  |  | dpm_zone_get_state |
| Security / Key Manager Client | tizenKeyManagerClient | ckmc_alias_info_get_alias |
...
| Security / Privacy Privilege Manager | tizenCapiPrivacyPrivilegeManager | ppm_check_app_permission |
...
| Security / Privilege Info | tizenPrivilegeInfo | privilege_info_free_privilege_info_list |
...
| Security / Web Authentication | tizenWebauthnClient | wauthn_cancel |
|  |  | wauthn_get_assertion |
|  |  | wauthn_make_credential |
|  |  | wauthn_set_api_version |
|  |  | wauthn_supported_authenticators |
| Security / YACA | tizenYaca | yaca_cleanup |
...
|  |  | yaca_verify_update |
|  |  | yaca_zalloc |
| Social / Calendar | tizenCalendarService2 | cal_caltime_create |
|  |  | cal_caltime_destroy |
...
| Social / Contacts | tizenContactsService2 | contacts_activity_delete_by_account_id |
...
| Social / Phonenumber utils | tizenPhonenumberUtils | phone_number_add_blocking_rule |
...
| System / Device | tizenCapiSystemDevice | battery_finalize |
...
|  |  | device_power_add_lock_count_change_callback |
...
|  |  | device_power_remove_lock_count_change_callback |
...
| System / Diagnostics | tizenDiagnostics | diagnostics_data_destroy |
...
| System / Dlog | tizenDlog | dlog_print |
|  |  | dlog_print_dotnet |
|  |  | dlog_print_native |
...
|  |  | dlog_vprint_dotnet |
|  |  | dlog_vprint_native |
| System / Feedback | tizenFeedback | feedback_deinitialize |
...
| System / Media key | tizenCapiSystemMediaKey | media_key_release |
|  |  | media_key_reserve |
| System / Monitor | tizenCapiSystemResourceMonitor | resource_monitor_create_resource |
...
| System / Peripheral IO | tizenCapiSystemPeripheralIo | peripheral_adc_close |
|  |  | peripheral_adc_open |
|  |  | peripheral_adc_read |
...
| System / Runtime information | tizenCapiSystemRuntimeInfo | runtime_info_app_usage_destroy |
...
| System / Sensor | tizenCapiSystemSensor | getAngleChange |
|  |  | getRotationMatrix |
|  |  | quatToMatrix |
...
|  |  | sensor_listener_get_attribute_int |
...
|  |  | setCoordinate |
| System / Storage | tizenStorage | storage_foreach_device_supported |
|  |  | storage_format_mmc |
...
| System / System Information | tizenCapiSystemInfo | system_info_get_custom_bool |
...
| System / System Settings | tizenCapiSystemSystemSettings | system_settings_add_changed_cb |
...
| System / T-trace | tizenTtrace | check_params |
|  |  | libttrace_fini |
|  |  | libttrace_init |
|  |  | trace_async_begin |
|  |  | traceAsyncBegin |
...
| System / USB Host | tizenCapiSystemUsbhost | usb_host_claim_interface |
...
| System / Update Control | tizenUpdateControl | update_control_cancel_reservation |
...
| UI / TBM Surface | tizenTbm | tbm_backend_alloc |
...
|  |  | tbm_surface_queue_get_next_dequeue |
...
|  |  | user_data_delete |
|  |  | user_data_lookup |
| UIX / Autofill | tizenCapiUiAutofill | autofill_auth_info_request |
...
| UIX / Autofill common | tizenCapiUiAutofillCommon | autofill_auth_info_create |
...
| UIX / Autofill manager | tizenCapiUiAutofillManager | autofill_manager_connect |
...
| UIX / Autofill service | tizenCapiUiAutofillService | autofill_service_deinitialize |
...
| UIX / Input Method | tizenCapiUiInputmethod | ime_commit_content |
|  |  | ime_commit_string |
...
|  |  | ime_update_property |
| UIX / Input Method Manager | tizenCapiUiInputmethodManager | ime_manager_get_active_ime |
...
| UIX / MMI | tizenMmi | mmi_attribute_clone |
...
| UIX / Multi assistant | tizenMa | ma_add_wake_word |
|  |  | ma_ap_client_create |
...
|  |  | stt_dbus_request_get_audio_format |
...
|  |  | stt_dbus_request_start_audio_streaming |
|  |  | stt_dbus_request_start_file |
|  |  | stt_dbus_request_stop |
|  |  | stt_dbus_request_stop_audio_streaming |
...
| UIX / STT Engine | tizenSttEngine | client_show_list |
|  |  | get_volume_decibel |
|  |  | read_audio_func |
...
|  |  | stt_parser_set_time_info |
|  |  | stt_parser_unload_config |
| UIX / TTS | tizenTts | rpc_port_proxy_array_char_clone |
...
|  |  | rpc_port_proxy_tts_invoke_add_silent_utterance |
|  |  | rpc_port_proxy_tts_invoke_add_text |
|  |  | rpc_port_proxy_tts_invoke_add_text_with_synthesis_parameter |
...
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_clone |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_create |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_destroy |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_background_volume |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_engine_type |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_langauge |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_pitch |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_ptts_id |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_speed |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_voice_type |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_get_volume |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_background_volume |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_engine_type |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_langauge |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_pitch |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_ptts_id |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_speed |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_voice_type |
|  |  | rpc_port_proxy_tts_synthesis_parameter_s_set_volume |
|  |  | tts_add_pcm |
|  |  | tts_add_silent_utterance |
|  |  | tts_add_text |
|  |  | tts_add_text_with_synthesis_parameter |
...
|  |  | tts_client_get_supported_personal_voice_user_data |
...
|  |  | tts_client_is_requested_to_destroy |
...
|  |  | tts_client_set_requested_to_destroy |
...
|  |  | tts_client_set_supported_personal_voice_cb |
...
|  |  | tts_config_mgr_check_duplicate_personal_voice |
...
|  |  | tts_config_mgr_get_personal_voice_list |
...
|  |  | tts_config_mgr_update_personal_voice |
|  |  | tts_core_add_pcm |
|  |  | tts_core_add_silent_utterance |
|  |  | tts_core_add_text |
|  |  | tts_core_add_text_with_synthesis_parameter |
|  |  | tts_core_check_credential |
|  |  | tts_core_check_screen_reader |
|  |  | tts_core_covert_error_code |
|  |  | tts_core_deinitialize |
|  |  | tts_core_foreach_supported_personal_voices |
...
|  |  | tts_dbus_request_add_silent_utterance |
|  |  | tts_dbus_request_add_text |
|  |  | tts_dbus_request_add_text_with_synthesis_parameter |
...
|  |  | tts_parser_free_personal_info |
|  |  | tts_parser_get_config_info |
|  |  | tts_parser_get_engine_info |
|  |  | tts_parser_get_personal_info |
...
|  |  | tts_parser_update_personal_info |
|  |  | tts_pause |
|  |  | tts_pause_async |
|  |  | tts_play |
|  |  | tts_play_async |
...
|  |  | tts_synthesis_parameter_set_engine_type |
|  |  | tts_synthesis_parameter_set_language |
|  |  | tts_synthesis_parameter_set_personal_voice |
|  |  | tts_synthesis_parameter_set_pitch |
|  |  | tts_synthesis_parameter_set_speed |
|  |  | tts_synthesis_parameter_set_voice_type |
|  |  | tts_synthesis_parameter_set_volume |
|  |  | tts_tidl_close_connection |
|  |  | tts_tidl_open_connection |
|  |  | tts_tidl_request_add_pcm |
|  |  | tts_tidl_request_add_silent_utterance |
|  |  | tts_tidl_request_add_text |
|  |  | tts_tidl_request_add_text_with_synthesis_parameter |
...
| UIX / TTS Engine | tizenTtsEngine | rpc_port_stub_array_char_clone |
...
|  |  | rpc_port_stub_tts_synthesis_parameter_s_clone |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_create |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_destroy |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_background_volume |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_engine_type |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_langauge |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_pitch |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_ptts_id |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_speed |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_voice_type |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_get_volume |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_background_volume |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_engine_type |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_langauge |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_pitch |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_ptts_id |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_speed |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_voice_type |
|  |  | rpc_port_stub_tts_synthesis_parameter_s_set_volume |
...
|  |  | ttsd_config_get_personal_voices_list |
...
|  |  | ttsd_config_update_personal_voice |
...
|  |  | ttsd_dbus_server_add_silent_utterance |
...
|  |  | ttsd_engine_agent_set_engine_type |
|  |  | ttsd_engine_agent_set_engine_type_set_cb |
|  |  | ttsd_engine_agent_set_personal_tts_id |
|  |  | ttsd_engine_agent_set_personal_tts_id_set_cb |
...
|  |  | ttsd_send_error |
|  |  | ttsd_send_personal_voice |
|  |  | ttsd_send_result |
|  |  | ttsd_server_add_pcm |
|  |  | ttsd_server_add_silent_utterance |
|  |  | ttsd_server_add_text |
|  |  | ttsd_server_add_text_with_synthesis_parameter |
...
|  |  | ttsd_set_personal_tts_id_set_cb |
...
|  |  | tts_parser_update_personal_info |
|  |  | tts_tag |
| UIX / Voice control | tizenVc | rpc_port_proxy_vc_proxy_array_char_clone |
...
| UIX / Voice control engine | tizenVcEngine | dependency_audio_manager_deinitialize |
...
|  |  | vc_search_text |
|  |  | vc_search_word |
| UIX / Voice control manager | tizenVcManager | rpc_port_proxy_vc_mgr_proxy_array_char_clone |
...
|  |  | vc_mgr_core_get_error_message |
|  |  | vc_mgr_core_get_volume |
|  |  | vc_mgr_core_initialize_volume_variable |
|  |  | vc_mgr_core_notify_error |
|  |  | vc_mgr_core_request_auth_cancel |
|  |  | vc_mgr_core_request_auth_disable |
|  |  | vc_mgr_core_request_auth_enable |
|  |  | vc_mgr_core_request_auth_start |
|  |  | vc_mgr_core_request_auth_stop |
|  |  | vc_mgr_core_send_all_result |
|  |  | vc_mgr_core_send_dialog |
|  |  | vc_mgr_core_send_error |
|  |  | vc_mgr_core_send_feedback_audio_format |
|  |  | vc_mgr_core_send_feedback_streaming |
|  |  | vc_mgr_core_send_pre_result |
|  |  | vc_mgr_core_send_private_data_requested |
|  |  | vc_mgr_core_send_private_data_set |
|  |  | vc_mgr_core_send_service_state |
|  |  | vc_mgr_core_send_set_foreground |
|  |  | vc_mgr_core_send_set_volume |
|  |  | vc_mgr_core_send_specific_engine_result |
|  |  | vc_mgr_core_send_speech_detected |
|  |  | vc_mgr_core_send_system_result |
|  |  | vc_mgr_core_set_demandable_client_rule |
|  |  | vc_mgr_core_set_selected_results |
|  |  | vc_mgr_core_set_volume |

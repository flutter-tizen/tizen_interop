...
|  |  | app_manager_get_common_shared_data_path |
|  |  | app_manager_get_common_shared_trusted_path |
...
|  |  | app_manager_request_remount_subsession |
...
| Application Framework / Notification | tizenNotification | make_dnd_allow_exception_from_exception |
|  |  | make_empty_notification |
|  |  | make_notification_from_noti |
|  |  | make_noti_from_notification |
|  |  | make_noti_setting_from_setting |
|  |  | make_noti_system_setting_from_setting |
|  |  | make_setting_from_noti_setting |
|  |  | make_setting_from_noti_system_setting |
...
|  |  | notification_noti_delete_channel |
...
|  |  | notification_noti_get_channel |
|  |  | notification_noti_get_channel_list |
...
|  |  | notification_noti_insert_channel |
|  |  | notification_noti_update |
|  |  | notification_noti_update_channel |
...
|  |  | package_info_get_first_installed_time |
...
|  |  | package_info_is_update_package |
...
|  |  | package_manager_detailed_error_to_string |
...
|  |  | package_manager_get_last_detailed_error |
...
|  |  | webrtc_media_source_active_transceiver_encoding |
...
|  |  | webrtc_media_source_get_transceiver_mid |
|  |  | webrtc_media_source_get_transceiver_recv_drop |
|  |  | webrtc_media_source_get_type |
...
|  |  | webrtc_null_source_set_media_type |
...
|  |  | wifi_direct_add_dhcp_vendor_info |
...
| UI / TBM Surface | tizenTbm | tbm_backend_bufmgr_alloc_bo_func |
...
|  |  | tts_parser_open_with_flock |
|  |  | tts_parser_print_engine_info |
|  |  | tts_parser_reset |
|  |  | tts_parser_save_with_flock |
